; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//593/original.bc'
...
while.cond.outer:                                 ; preds = %entry, %rollback
  ...
  %data.addr.0.ph = phi ptr [ %6, %rollback ], [ null, %entry ]
...
for.cond.preheader:                               ; preds = %for.cond.preheader.lr.ph, %for.cond.preheader
  %4 = phi ptr [ %5, %for.cond.preheader ], [ %3, %for.cond.preheader.lr.ph ]
  tail call void %4(ptr null, ptr null, ptr null, ptr %data.addr.0.ph)
...
rollback:                                         ; preds = %for.cond.preheader, %while.cond.outer
  %6 = load ptr, ptr %data471, align 8
