; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//964/reordered.bc'
...
L10:                                              ; preds = %entry, %for.end342
  ...
  %cmp316.not1 = icmp slt i32 %2, 0
  br i1 %cmp316.not1, label %for.end342, label %for.body317

L10.us:                                           ; preds = %entry
  store i32 0, ptr %uplo, align 4
  %3 = load i32, ptr %n, align 4
  %cmp316.not1.us = icmp slt i32 %3, 0
...
for.body317.us:                                   ; preds = %L10.us, %for.body317.us
  ...
  %cmp316.not.us = icmp slt i32 %4, 0
