; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//405/reordered.bc'
...
for.cond44.preheader.lr.ph.split.us:              ; preds = %entry.split
  %1 = icmp slt i32 %0, 0
  br i1 %1, label %for.body51, label %for.cond48.preheader.us

for.cond.us:                                      ; preds = %entry, %for.cond.us
  %2 = load ptr, ptr %gen, align 8
  %call.us = tail call i32 %2(ptr null)
...
entry.split:                                      ; preds = %entry
  ...
  %call2 = tail call i32 %3(ptr null)
