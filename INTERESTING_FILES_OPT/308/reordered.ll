; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//308/reordered.bc'
...
sw.bb3.i.us:                                      ; preds = %while.cond.us
  %2 = load i8, ptr inttoptr (i64 -3 to ptr), align 1
  %conv4.i.us = zext i8 %2 to i32
...
sw.bb3.i3:                                        ; preds = %sdslen.exit
  %4 = load i8, ptr inttoptr (i64 -3 to ptr), align 1
  %conv4.i4 = zext i8 %4 to i32
