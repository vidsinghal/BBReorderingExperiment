; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//862/reordered.bc'
...
for.cond.us:                                      ; preds = %entry.split.us, %for.cond.us
  ...
  %call288.us = tail call i32 (ptr, ...) %6(ptr null, i32 0, i32 0, i32 0)
  %7 = load ptr, ptr %SymbolicHandle, align 8
  %call318.us = tail call i32 (ptr, ...) %7(ptr null, i32 0, i32 0, i32 0, i32 0)
  br label %for.cond.us

for.cond.us.us:                                   ; preds = %entry.split.us, %for.cond.us.us
  %8 = load ptr, ptr %SymbolicHandle, align 8
  %call318.us.us = tail call i32 (ptr, ...) %8(ptr null, i32 0, i32 0, i32 0, i32 0)
