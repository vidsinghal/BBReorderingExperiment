; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//282/reordered.bc'
...
for.body8.us:                                     ; preds = %for.cond6.preheader.us, %for.body8.us
  %1 = phi i32 [ %inc.us, %for.body8.us ], [ 0, %for.cond6.preheader.us ]
  %call10.us = tail call double @z_abs()
  %inc.us = add i32 %1, 1
  %cmp7.not.us = icmp sgt i32 %inc.us, %2
...
for.cond6.preheader.us:                           ; preds = %for.cond6.preheader.us.backedge, %for.cond6.preheader.lr.ph
  %2 = phi i32 [ 0, %for.cond6.preheader.lr.ph ], [ %add16, %for.cond6.preheader.us.backedge ]
  %cmp7.not1.us = icmp slt i32 %2, 0
