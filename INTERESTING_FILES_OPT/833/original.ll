; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//833/original.bc'
...
for.end156.split.us.us:                           ; preds = %for.cond103.us.us
  ...
  %call162.us = tail call i32 %0(ptr null, ptr null, ptr null)
...
for.end156.split:                                 ; preds = %entry.split, %for.end156.split
  ...
  %call162 = tail call i32 %1(ptr null, ptr null, ptr null)
