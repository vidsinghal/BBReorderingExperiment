; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//456/original.bc'
...
while.cond.us:                                    ; preds = %entry
  ...
  %cmp4.peel.i.us = icmp sgt i32 %0, 0
...
if.end.peel.i.us:                                 ; preds = %while.cond.us
  ...
  %cmp19.peel.i.us = icmp sgt i32 %1, 0
