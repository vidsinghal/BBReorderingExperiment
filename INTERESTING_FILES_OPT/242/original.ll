; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//242/original.bc'
...
do.body20.i:                                      ; preds = %for.cond
  ...
  %tobool79.not.i = icmp eq ptr %2, null
...
for.cond.outer.backedge:                          ; preds = %do.body20.i, %if.then80.i
  %.pre1.ph.be = phi i32 [ %.pre.pre, %if.then80.i ], [ %4, %do.body20.i ]
...
if.then80.i:                                      ; preds = %do.body20.i
  %5 = load ptr, ptr %attach_cb81.i, align 8
  tail call void %5(ptr null, ptr null, ptr null, ptr null)
