; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//546/reordered.bc'
...
while.cond.us:                                    ; preds = %entry.split.us, %malloc_conf_next.exit.us
  %6 = phi i8 [ %7, %malloc_conf_next.exit.us ], [ 0, %entry.split.us ]
  %cond1.i.us = icmp eq i8 %6, 0
...
malloc_conf_next.exit.us:                         ; preds = %sw.bb1.i.us, %while.cond.us
  %7 = phi i8 [ %6, %while.cond.us ], [ %1, %sw.bb1.i.us ]
  %8 = load i64, ptr %0, align 8
  %cmp16.us = icmp eq i64 %8, 0
...
entry.split.us.split.us:                          ; preds = %entry.split.us
  ...
  %cmp16.us.us = icmp eq i64 %9, 0
  br i1 %cmp16.us.us, label %land.lhs.true18, label %while.cond.us.us

while.cond:                                       ; preds = %entry, %if.end54
  %10 = load i8, ptr inttoptr (i64 1 to ptr), align 1
  %cond1.i = icmp eq i8 %10, 0
