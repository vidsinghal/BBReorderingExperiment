; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//427/original.bc'
...
cond.false.i:                                     ; preds = %for.cond495
  %1 = load ptr, ptr %pFont, align 8
  %call.i = tail call i32 %1(i32 0, ptr null)
  br label %cond.end.i
...
pcfPutLSB32.exit:                                 ; preds = %cond.end.i, %cond.true7.i
  %3 = load ptr, ptr %output47.i, align 8
  %call51.i = tail call i32 %3(i32 0, ptr null)
  br label %for.cond495
}
...
cond.false:                                       ; preds = %entry
  ...
  %call = tail call i32 %1(i32 0, ptr null)
  br label %cond.end
...
cond.end18:                                       ; preds = %cond.true7, %cond.end
  ...
  %call51 = tail call i32 %3(i32 0, ptr null)
  ret i32 0
}
