; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//219/original.bc'
...
entry.split.us:                                   ; preds = %entry
  %1 = load i8, ptr %tyrcountinfo, align 1
  %cmp3.not.peel.i.us = icmp eq i8 %1, 0
...
while.cond.us.us.us:                              ; preds = %entry.split.us.split.us, %while.cond.us.us.us
  ...
  %tobool17.not.us.us.us = icmp eq i32 %2, 0
...
while.cond.us.us:                                 ; preds = %entry.split.us.split.us.split, %while.cond.us.us
  store volatile i32 0, ptr null, align 4294967296
  %4 = load i32, ptr %searchstrand, align 4
  %tobool17.not.us.us = icmp eq i32 %4, 0
...
while.cond.us:                                    ; preds = %entry.split.us, %while.cond.us
  ...
  %tobool17.not.us = icmp eq i32 %5, 0
...
for.body.peel:                                    ; preds = %entry
  %0 = load i8, ptr %seq, align 1
  %cmp3.not.peel = icmp eq i8 %0, 0
