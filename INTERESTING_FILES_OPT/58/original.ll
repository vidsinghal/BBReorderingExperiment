; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//58/original.bc'
...
for.body.us.us.us:                                ; preds = %for.body.lr.ph.split.us, %for.body.us.us.us
  ...
  %conv32.us.us.us = sext i8 %1 to i32
  %2 = load ptr, ptr %my_mvaddch, align 8
  tail call void %2(ptr null, i32 0, i32 0, i32 %conv32.us.us.us)
  br label %for.body.us.us.us

for.body.us.us7:                                  ; preds = %for.body.lr.ph.split.us, %for.body.us.us7
  %3 = load ptr, ptr %data, align 8
  tail call void (ptr, i32, i32, ptr, ...) %3(ptr null, i32 0, i32 0, ptr null, i64 0)
  %4 = load ptr, ptr %my_mvaddch, align 8
  tail call void %4(ptr null, i32 0, i32 0, i32 0)
...
for.body.us1.us:                                  ; preds = %for.body.lr.ph.split, %for.body.us1.us
  ...
  %conv32.us3.us = sext i8 %5 to i32
  %6 = load ptr, ptr %my_mvaddch, align 8
  tail call void %6(ptr null, i32 0, i32 0, i32 %conv32.us3.us)
