; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//900/reordered.bc'
...
if.end278.i:                                      ; preds = %for.end265.i
  %2 = load ptr, ptr inttoptr (i64 8 to ptr), align 8
  %cmp285.i = icmp eq ptr %2, null
