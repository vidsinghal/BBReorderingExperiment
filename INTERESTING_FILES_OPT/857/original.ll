; ModuleID = '/g/g91/singhal2/BBReorderingExperiment/INTERESTING_FILES_OPT//857/original.bc'
...
lor.lhs.false12.outer.us:                         ; preds = %entry, %next_marker.exit.us
  %.ph.us = phi i32 [ %1, %next_marker.exit.us ], [ 1, %entry ]
...
next_marker.exit.us:                              ; preds = %sw.bb43.us
  %1 = load i32, ptr %unread_marker46, align 4
...
sw.bb43.us:                                       ; preds = %lor.lhs.false12.outer.us, %lor.lhs.false12.outer.split.us2
  %2 = load ptr, ptr inttoptr (i64 24 to ptr), align 8
  %call.i.us = tail call i32 %2(ptr null)
