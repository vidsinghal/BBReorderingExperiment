; ModuleID = 'samples/68.bc'
source_filename = "/local-ssd/xnnpack-r7msi2beibvbxa3e6lvblom7qlyd5i24-build/aidengro/spack-stage-xnnpack-2022-02-16-r7msi2beibvbxa3e6lvblom7qlyd5i24/spack-src/src/f32-vunary/gen/vabs-sse-x4.c"
...
define hidden void @xnn_f32_vabs_ukernel__sse_x4(i64 noundef %n, ptr noundef %x, ptr noundef %y, ptr noalias noundef align 32 dereferenceable(96) %params) #0 {
entry:
  ...
  %nonsign_mask = getelementptr inbounds %struct.anon, ptr %0, i32 0, i32 0
  %arraydecay = getelementptr inbounds [4 x float], ptr %nonsign_mask, i64 0, i64 0
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load <4 x float>, ptr %vnonsign_mask, align 16, !tbaa !11
  %call2 = call <4 x float> @_mm_and_ps(<4 x float> noundef %4, <4 x float> noundef %5)
...
if.then:                                          ; preds = %for.end
  ...
  %13 = load <4 x float>, ptr %vnonsign_mask, align 16, !tbaa !11
  %call7 = call <4 x float> @_mm_and_ps(<4 x float> noundef %12, <4 x float> noundef %13)
