...
%struct.dsa_st = type { i32, i32, %struct.ffc_params_st, ptr, ptr, i32, ptr, i32, %struct.crypto_ex_data_st, ptr, ptr, ptr, ptr, i64 }
...
entry:
  ...
  store ptr %pubkey, ptr %pubkey.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %pm) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %pklen) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %pmlen) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %ptype) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %pval) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %pstr) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %palg) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %public_key) #3
  store ptr null, ptr %public_key, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %dsa) #3
  store ptr null, ptr %dsa, align 8, !tbaa !4
  %0 = load ptr, ptr %pubkey.addr, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %palg, align 8, !tbaa !4
  call void @X509_ALGOR_get0(ptr noundef null, ptr noundef %ptype, ptr noundef %pval, ptr noundef %1)
  %2 = load i32, ptr %ptype, align 4, !tbaa !8
  %cmp = icmp eq i32 %2, 16
  br i1 %cmp, label %if.then1, label %if.else

if.then1:                                         ; preds = %if.end
  %3 = load ptr, ptr %pval, align 8, !tbaa !4
  store ptr %3, ptr %pstr, align 8, !tbaa !4
  %4 = load ptr, ptr %pstr, align 8, !tbaa !4
  %data = getelementptr inbounds %struct.asn1_string_st, ptr %4, i32 0, i32 2
  %5 = load ptr, ptr %data, align 8, !tbaa !10
  store ptr %5, ptr %pm, align 8, !tbaa !4
  %6 = load ptr, ptr %pstr, align 8, !tbaa !4
  %length = getelementptr inbounds %struct.asn1_string_st, ptr %6, i32 0, i32 0
  %7 = load i32, ptr %length, align 8, !tbaa !13
  store i32 %7, ptr %pmlen, align 4, !tbaa !8
  %8 = load i32, ptr %pmlen, align 4, !tbaa !8
  %conv = sext i32 %8 to i64
  %call2 = call ptr @d2i_DSAparams(ptr noundef null, ptr noundef %pm, i64 noundef %conv)
  store ptr %call2, ptr %dsa, align 8, !tbaa !4
...
if.else:                                          ; preds = %if.end
  %9 = load i32, ptr %ptype, align 4, !tbaa !8
  %cmp7 = icmp eq i32 %9, 5
  br i1 %cmp7, label %if.then11, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.else
  %10 = load i32, ptr %ptype, align 4, !tbaa !8
...
if.then11:                                        ; preds = %lor.lhs.false, %if.else
  ...
  store ptr %call12, ptr %dsa, align 8, !tbaa !4
...
if.then15:                                        ; preds = %if.then11
  ...
  call void (i32, i32, ptr, ...) @ERR_set_error(i32 noundef 10, i32 noundef 786688, ptr noundef null)
  br label %err
...
if.end30:                                         ; preds = %if.end25
  %14 = load ptr, ptr %dsa, align 8, !tbaa !4
  %dirty_cnt = getelementptr inbounds %struct.dsa_st, ptr %14, i32 0, i32 13
  %15 = load i64, ptr %dirty_cnt, align 8, !tbaa !18
  %inc = add i64 %15, 1
  store i64 %inc, ptr %dirty_cnt, align 8, !tbaa !18
  %16 = load ptr, ptr %public_key, align 8, !tbaa !4
  call void @ASN1_INTEGER_free(ptr noundef %16)
  %17 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %18 = load ptr, ptr %dsa, align 8, !tbaa !4
...
err:                                              ; preds = %if.then29, %if.then24, %if.else17, %if.then15, %if.then5
  %19 = load ptr, ptr %public_key, align 8, !tbaa !4
  call void @ASN1_INTEGER_free(ptr noundef %19)
  %20 = load ptr, ptr %dsa, align 8, !tbaa !4
...
cleanup:                                          ; preds = %err, %if.end30, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %public_key) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %palg) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pstr) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pval) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %ptype) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %pmlen) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %pklen) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pm) #3
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %dsa) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %ptype) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %penc) #3
  store ptr null, ptr %penc, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %penclen) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %str) #3
  store ptr null, ptr %str, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %pubint) #3
  store ptr null, ptr %pubint, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %aobj) #3
  %0 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %pkey1 = getelementptr inbounds %struct.evp_pkey_st, ptr %0, i32 0, i32 5
  %1 = load ptr, ptr %pkey1, align 8, !tbaa !19
  store ptr %1, ptr %dsa, align 8, !tbaa !4
  %2 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %save_parameters = getelementptr inbounds %struct.evp_pkey_st, ptr %2, i32 0, i32 10
  %3 = load i32, ptr %save_parameters, align 8, !tbaa !20
  %tobool = icmp ne i32 %3, 0
  br i1 %tobool, label %land.lhs.true, label %if.else

land.lhs.true:                                    ; preds = %entry
  %4 = load ptr, ptr %dsa, align 8, !tbaa !4
  ...
  %5 = load ptr, ptr %p, align 8, !tbaa !23
  %cmp = icmp ne ptr %5, null
  br i1 %cmp, label %land.lhs.true2, label %if.else

land.lhs.true2:                                   ; preds = %land.lhs.true
  %6 = load ptr, ptr %dsa, align 8, !tbaa !4
  ...
  %7 = load ptr, ptr %q, align 8, !tbaa !24
  %cmp4 = icmp ne ptr %7, null
  br i1 %cmp4, label %land.lhs.true5, label %if.else

land.lhs.true5:                                   ; preds = %land.lhs.true2
  %8 = load ptr, ptr %dsa, align 8, !tbaa !4
  ...
  %9 = load ptr, ptr %g, align 8, !tbaa !25
...
if.end:                                           ; preds = %if.then
  %11 = load ptr, ptr %dsa, align 8, !tbaa !4
...
if.end14:                                         ; preds = %if.end
  store i32 16, ptr %ptype, align 4, !tbaa !8
  br label %if.end15

if.else:                                          ; preds = %land.lhs.true5, %land.lhs.true2, %land.lhs.true, %entry
  store i32 -1, ptr %ptype, align 4, !tbaa !8
  br label %if.end15

if.end15:                                         ; preds = %if.else, %if.end14
  %16 = load ptr, ptr %dsa, align 8, !tbaa !4
  %pub_key = getelementptr inbounds %struct.dsa_st, ptr %16, i32 0, i32 3
  %17 = load ptr, ptr %pub_key, align 8, !tbaa !14
  %call16 = call ptr @BN_to_ASN1_INTEGER(ptr noundef %17, ptr noundef null)
  store ptr %call16, ptr %pubint, align 8, !tbaa !4
  %18 = load ptr, ptr %pubint, align 8, !tbaa !4
...
if.end19:                                         ; preds = %if.end15
  %19 = load ptr, ptr %pubint, align 8, !tbaa !4
  %call20 = call i32 @i2d_ASN1_INTEGER(ptr noundef %19, ptr noundef %penc)
  store i32 %call20, ptr %penclen, align 4, !tbaa !8
  %20 = load ptr, ptr %pubint, align 8, !tbaa !4
  call void @ASN1_INTEGER_free(ptr noundef %20)
  %21 = load i32, ptr %penclen, align 4, !tbaa !8
...
if.end23:                                         ; preds = %if.end19
  ...
  store ptr %call24, ptr %aobj, align 8, !tbaa !4
  %22 = load ptr, ptr %aobj, align 8, !tbaa !4
...
if.end27:                                         ; preds = %if.end23
  %23 = load ptr, ptr %pk.addr, align 8, !tbaa !4
  %24 = load ptr, ptr %aobj, align 8, !tbaa !4
  %25 = load i32, ptr %ptype, align 4, !tbaa !8
  %26 = load ptr, ptr %str, align 8, !tbaa !4
  %27 = load ptr, ptr %penc, align 8, !tbaa !4
  %28 = load i32, ptr %penclen, align 4, !tbaa !8
...
err:                                              ; preds = %if.end31, %if.then26, %if.then22, %if.then18, %if.then13, %if.then9
  %29 = load ptr, ptr %penc, align 8, !tbaa !4
...
cleanup:                                          ; preds = %err, %if.then30
  call void @llvm.lifetime.end.p0(i64 8, ptr %aobj) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pubint) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %str) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %penclen) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %penc) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %ptype) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa) #3
...
entry:
  ...
  store ptr %pkey, ptr %pkey.addr, align 8, !tbaa !4
  store i32 %indent, ptr %indent.addr, align 4, !tbaa !8
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  %0 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %1 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %pkey1 = getelementptr inbounds %struct.evp_pkey_st, ptr %1, i32 0, i32 5
  %2 = load ptr, ptr %pkey1, align 8, !tbaa !19
  %3 = load i32, ptr %indent.addr, align 4, !tbaa !8
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %3 = load ptr, ptr %dsa, align 8, !tbaa !4
...
entry:
  ...
  store ptr %p8, ptr %p8.addr, align 8, !tbaa !4
  store ptr %pkey, ptr %pkey.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %params) #3
  store ptr null, ptr %params, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %prkey) #3
  store ptr null, ptr %prkey, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %dp) #3
  store ptr null, ptr %dp, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %dplen) #3
  %0 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %pkey1 = getelementptr inbounds %struct.evp_pkey_st, ptr %0, i32 0, i32 5
  %1 = load ptr, ptr %pkey1, align 8, !tbaa !19
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %3 = load ptr, ptr %pkey2, align 8, !tbaa !19
  %priv_key = getelementptr inbounds %struct.dsa_st, ptr %3, i32 0, i32 4
  %4 = load ptr, ptr %priv_key, align 8, !tbaa !26
...
if.end:                                           ; preds = %lor.lhs.false
  %call = call ptr @ASN1_STRING_new()
  store ptr %call, ptr %params, align 8, !tbaa !4
...
if.end6:                                          ; preds = %if.end
  ...
  %7 = load ptr, ptr %pkey7, align 8, !tbaa !19
  ...
  store i32 %call8, ptr %length, align 8, !tbaa !13
  %10 = load ptr, ptr %params, align 8, !tbaa !4
  %length9 = getelementptr inbounds %struct.asn1_string_st, ptr %10, i32 0, i32 0
  %11 = load i32, ptr %length9, align 8, !tbaa !13
...
if.end12:                                         ; preds = %if.end6
  ...
  store i32 16, ptr %type, align 4, !tbaa !27
  %13 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %pkey13 = getelementptr inbounds %struct.evp_pkey_st, ptr %13, i32 0, i32 5
  %14 = load ptr, ptr %pkey13, align 8, !tbaa !19
  %priv_key14 = getelementptr inbounds %struct.dsa_st, ptr %14, i32 0, i32 4
  %15 = load ptr, ptr %priv_key14, align 8, !tbaa !26
  %call15 = call ptr @BN_to_ASN1_INTEGER(ptr noundef %15, ptr noundef null)
  store ptr %call15, ptr %prkey, align 8, !tbaa !4
  %16 = load ptr, ptr %prkey, align 8, !tbaa !4
...
if.end18:                                         ; preds = %if.end12
  %17 = load ptr, ptr %prkey, align 8, !tbaa !4
  %call19 = call i32 @i2d_ASN1_INTEGER(ptr noundef %17, ptr noundef %dp)
  store i32 %call19, ptr %dplen, align 4, !tbaa !8
  %18 = load ptr, ptr %prkey, align 8, !tbaa !4
  call void @ASN1_STRING_clear_free(ptr noundef %18)
  %19 = load i32, ptr %dplen, align 4, !tbaa !8
...
if.end22:                                         ; preds = %if.end18
  %20 = load ptr, ptr %p8.addr, align 8, !tbaa !4
  %call23 = call ptr @OBJ_nid2obj(i32 noundef 116)
  %21 = load ptr, ptr %params, align 8, !tbaa !4
  %22 = load ptr, ptr %dp, align 8, !tbaa !4
  %23 = load i32, ptr %dplen, align 4, !tbaa !8
...
if.then25:                                        ; preds = %if.end22
  %24 = load ptr, ptr %dp, align 8, !tbaa !4
  %25 = load i32, ptr %dplen, align 4, !tbaa !8
...
err:                                              ; preds = %if.then25, %if.then21, %if.then17, %if.then11, %if.then5, %if.then
  %26 = load ptr, ptr %params, align 8, !tbaa !4
...
cleanup:                                          ; preds = %err, %if.end26
  call void @llvm.lifetime.end.p0(i64 4, ptr %dplen) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dp) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %prkey) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %params) #3
...
entry:
  ...
  %cleanup.dest.slot = alloca i32, align 4
  store ptr %pkey, ptr %pkey.addr, align 8, !tbaa !4
  store ptr %pder, ptr %pder.addr, align 8, !tbaa !4
  store i32 %derlen, ptr %derlen.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %dsa) #3
  %0 = load ptr, ptr %pder.addr, align 8, !tbaa !4
  %1 = load i32, ptr %derlen.addr, align 4, !tbaa !8
...
if.end:                                           ; preds = %entry
  %2 = load ptr, ptr %dsa, align 8, !tbaa !4
  %dirty_cnt = getelementptr inbounds %struct.dsa_st, ptr %2, i32 0, i32 13
  %3 = load i64, ptr %dirty_cnt, align 8, !tbaa !18
  %inc = add i64 %3, 1
  store i64 %inc, ptr %dirty_cnt, align 8, !tbaa !18
  %4 = load ptr, ptr %pkey.addr, align 8, !tbaa !4
  %5 = load ptr, ptr %dsa, align 8, !tbaa !4
...
entry:
  ...
  %pkey1 = getelementptr inbounds %struct.evp_pkey_st, ptr %0, i32 0, i32 5
  %1 = load ptr, ptr %pkey1, align 8, !tbaa !19
  %2 = load ptr, ptr %pder.addr, align 8, !tbaa !4
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %p = getelementptr inbounds %struct.ffc_params_st, ptr %params, i32 0, i32 0
  %4 = load ptr, ptr %p, align 8, !tbaa !23
...
lor.lhs.false3:                                   ; preds = %lor.lhs.false
  ...
  %6 = load ptr, ptr %q, align 8, !tbaa !24
  %cmp5 = icmp eq ptr %6, null
  br i1 %cmp5, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %lor.lhs.false3
  %7 = load ptr, ptr %dsa, align 8, !tbaa !4
  %params6 = getelementptr inbounds %struct.dsa_st, ptr %7, i32 0, i32 2
  %g = getelementptr inbounds %struct.ffc_params_st, ptr %params6, i32 0, i32 2
  %8 = load ptr, ptr %g, align 8, !tbaa !25
...
if.end5:                                          ; preds = %if.end, %entry
  %5 = load ptr, ptr %to.addr, align 8, !tbaa !4
  %pkey6 = getelementptr inbounds %struct.evp_pkey_st, ptr %5, i32 0, i32 5
  %6 = load ptr, ptr %pkey6, align 8, !tbaa !19
  ...
  %8 = load ptr, ptr %pkey7, align 8, !tbaa !19
...
entry:
  ...
  %pkey1 = getelementptr inbounds %struct.evp_pkey_st, ptr %2, i32 0, i32 5
  %3 = load ptr, ptr %pkey1, align 8, !tbaa !19
...
entry:
  ...
  store ptr %bp, ptr %bp.addr, align 8, !tbaa !4
  store ptr %sigalg, ptr %sigalg.addr, align 8, !tbaa !4
  store ptr %sig, ptr %sig.addr, align 8, !tbaa !4
  store i32 %indent, ptr %indent.addr, align 4, !tbaa !8
  store ptr %pctx, ptr %pctx.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %dsa_sig) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #3
  %0 = load ptr, ptr %sig.addr, align 8, !tbaa !4
...
if.end11:                                         ; preds = %if.then6
  %9 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %10 = load ptr, ptr %r, align 8, !tbaa !4
  %11 = load i32, ptr %indent.addr, align 4, !tbaa !8
...
if.end14:                                         ; preds = %if.end11
  %12 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %13 = load ptr, ptr %s, align 8, !tbaa !4
  %14 = load i32, ptr %indent.addr, align 4, !tbaa !8
...
if.end18:                                         ; preds = %if.end14
  store i32 1, ptr %rv, align 4, !tbaa !8
  br label %err

err:                                              ; preds = %if.end18, %if.then17, %if.then13, %if.then10
  %15 = load ptr, ptr %dsa_sig, align 8, !tbaa !4
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %rv) #3
  br label %cleanup

if.end19:                                         ; preds = %if.end
  %17 = load ptr, ptr %bp.addr, align 8, !tbaa !4
...
if.end24:                                         ; preds = %if.end19
  %18 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %19 = load ptr, ptr %sig.addr, align 8, !tbaa !4
  %20 = load i32, ptr %indent.addr, align 4, !tbaa !8
  %call25 = call i32 @X509_signature_dump(ptr noundef %18, ptr noundef %19, i32 noundef %20)
  store i32 %call25, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end24, %if.then23, %err, %if.else, %if.then2
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa_sig) #3
  %21 = load i32, ptr %retval, align 4
  ret i32 %21
}
...
entry:
  ...
  store ptr %pkey, ptr %pkey.addr, align 8, !tbaa !4
  store i32 %op, ptr %op.addr, align 4, !tbaa !8
  store i64 %arg1, ptr %arg1.addr, align 8, !tbaa !28
  store ptr %arg2, ptr %arg2.addr, align 8, !tbaa !4
  %0 = load i32, ptr %op.addr, align 4, !tbaa !8
...
entry:
  ...
  %2 = load i64, ptr %dirty_cnt, align 8, !tbaa !18
  ret i64 %2
}
...
entry:
  ...
  %cleanup.dest.slot = alloca i32, align 4
  store ptr %from, ptr %from.addr, align 8, !tbaa !4
  store ptr %to_keydata, ptr %to_keydata.addr, align 8, !tbaa !4
  store ptr %importer, ptr %importer.addr, align 8, !tbaa !4
  ...
  %1 = load ptr, ptr %pkey, align 8, !tbaa !19
  store ptr %1, ptr %dsa, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %tmpl) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #3
  %2 = load ptr, ptr %dsa, align 8, !tbaa !4
  ...
  store ptr %call1, ptr %g, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %q) #3
  %4 = load ptr, ptr %dsa, align 8, !tbaa !4
  %call2 = call ptr @DSA_get0_q(ptr noundef %4)
  store ptr %call2, ptr %q, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %pub_key) #3
  %5 = load ptr, ptr %dsa, align 8, !tbaa !4
  %call3 = call ptr @DSA_get0_pub_key(ptr noundef %5)
  store ptr %call3, ptr %pub_key, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %priv_key) #3
  %6 = load ptr, ptr %dsa, align 8, !tbaa !4
  %call4 = call ptr @DSA_get0_priv_key(ptr noundef %6)
  store ptr %call4, ptr %priv_key, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %params) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %selection) #3
  store i32 0, ptr %selection, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %rv) #3
  store i32 0, ptr %rv, align 4, !tbaa !8
...
lor.lhs.false6:                                   ; preds = %lor.lhs.false
  %9 = load ptr, ptr %g, align 8, !tbaa !4
...
if.end:                                           ; preds = %lor.lhs.false6
  ...
  store ptr %call8, ptr %tmpl, align 8, !tbaa !4
  %10 = load ptr, ptr %tmpl, align 8, !tbaa !4
...
if.end11:                                         ; preds = %if.end
  %11 = load ptr, ptr %tmpl, align 8, !tbaa !4
...
lor.lhs.false13:                                  ; preds = %if.end11
  %13 = load ptr, ptr %tmpl, align 8, !tbaa !4
...
lor.lhs.false16:                                  ; preds = %lor.lhs.false13
  %15 = load ptr, ptr %tmpl, align 8, !tbaa !4
  %16 = load ptr, ptr %g, align 8, !tbaa !4
...
if.end20:                                         ; preds = %lor.lhs.false16
  %17 = load i32, ptr %selection, align 4, !tbaa !8
  %or = or i32 %17, 4
  store i32 %or, ptr %selection, align 4, !tbaa !8
  %18 = load ptr, ptr %pub_key, align 8, !tbaa !4
  %cmp21 = icmp ne ptr %18, null
  br i1 %cmp21, label %if.then22, label %if.end28

if.then22:                                        ; preds = %if.end20
  %19 = load ptr, ptr %tmpl, align 8, !tbaa !4
...
if.end26:                                         ; preds = %if.then22
  %21 = load i32, ptr %selection, align 4, !tbaa !8
  %or27 = or i32 %21, 2
  store i32 %or27, ptr %selection, align 4, !tbaa !8
  br label %if.end28

if.end28:                                         ; preds = %if.end26, %if.end20
  %22 = load ptr, ptr %priv_key, align 8, !tbaa !4
  %cmp29 = icmp ne ptr %22, null
  br i1 %cmp29, label %if.then30, label %if.end36

if.then30:                                        ; preds = %if.end28
  %23 = load ptr, ptr %tmpl, align 8, !tbaa !4
  %24 = load ptr, ptr %priv_key, align 8, !tbaa !4
...
if.end34:                                         ; preds = %if.then30
  %25 = load i32, ptr %selection, align 4, !tbaa !8
  %or35 = or i32 %25, 1
  store i32 %or35, ptr %selection, align 4, !tbaa !8
  br label %if.end36

if.end36:                                         ; preds = %if.end34, %if.end28
  %26 = load ptr, ptr %tmpl, align 8, !tbaa !4
  %call37 = call ptr @OSSL_PARAM_BLD_to_param(ptr noundef %26)
  store ptr %call37, ptr %params, align 8, !tbaa !4
...
if.end40:                                         ; preds = %if.end36
  %27 = load ptr, ptr %importer.addr, align 8, !tbaa !4
  %28 = load ptr, ptr %to_keydata.addr, align 8, !tbaa !4
  %29 = load i32, ptr %selection, align 4, !tbaa !8
  ...
  %31 = load ptr, ptr %params, align 8, !tbaa !4
  call void @OSSL_PARAM_free(ptr noundef %31)
  br label %err

err:                                              ; preds = %if.end40, %if.then39, %if.then33, %if.then25, %if.then19
  %32 = load ptr, ptr %tmpl, align 8, !tbaa !4
  call void @OSSL_PARAM_BLD_free(ptr noundef %32)
  %33 = load i32, ptr %rv, align 4, !tbaa !8
  store i32 %33, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %err, %if.then10, %if.then
  call void @llvm.lifetime.end.p0(i64 4, ptr %rv) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %selection) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %params) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %priv_key) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pub_key) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %q) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %g) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %tmpl) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa) #3
...
entry:
  ...
  store ptr %vpctx, ptr %vpctx.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %pctx) #3
  %0 = load ptr, ptr %vpctx.addr, align 8, !tbaa !4
  store ptr %0, ptr %pctx, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %pkey) #3
  %1 = load ptr, ptr %pctx, align 8, !tbaa !4
  %call = call ptr @EVP_PKEY_CTX_get0_pkey(ptr noundef %1)
  store ptr %call, ptr %pkey, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %dsa) #3
  %2 = load ptr, ptr %pctx, align 8, !tbaa !4
  %libctx = getelementptr inbounds %struct.evp_pkey_ctx_st, ptr %2, i32 0, i32 1
  %3 = load ptr, ptr %libctx, align 8, !tbaa !29
  %call1 = call ptr @ossl_dsa_new(ptr noundef %3)
  store ptr %call1, ptr %dsa, align 8, !tbaa !4
  %4 = load ptr, ptr %dsa, align 8, !tbaa !4
...
lor.lhs.false5:                                   ; preds = %lor.lhs.false
  %9 = load ptr, ptr %pkey, align 8, !tbaa !4
  %10 = load ptr, ptr %dsa, align 8, !tbaa !4
...
cleanup:                                          ; preds = %if.end9, %if.then8, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pkey) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pctx) #3
  %12 = load i32, ptr %retval, align 4
  ret i32 %12
}
...
entry:
  ...
  %1 = load ptr, ptr %pkey, align 8, !tbaa !19
  store ptr %1, ptr %dsa, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %dupkey) #3
  store ptr null, ptr %dupkey, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #3
  %2 = load ptr, ptr %dsa, align 8, !tbaa !4
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call, ptr %dupkey, align 8, !tbaa !4
  %4 = load ptr, ptr %dupkey, align 8, !tbaa !4
...
if.end3:                                          ; preds = %if.end, %entry
  %5 = load ptr, ptr %to.addr, align 8, !tbaa !4
  %6 = load ptr, ptr %dupkey, align 8, !tbaa !4
...
if.then5:                                         ; preds = %if.end3
  %8 = load ptr, ptr %dupkey, align 8, !tbaa !4
...
cleanup:                                          ; preds = %if.end6, %if.then2
  call void @llvm.lifetime.end.p0(i64 4, ptr %ret) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dupkey) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %dsa) #3
...
entry:
  ...
  store i32 %off, ptr %off.addr, align 4, !tbaa !8
  store i32 %ptype, ptr %ptype.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #3
  store i32 0, ptr %ret, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %ktype) #3
  store ptr null, ptr %ktype, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %priv_key) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %pub_key) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %mod_len) #3
  store i32 0, ptr %mod_len, align 4, !tbaa !8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %call, ptr %mod_len, align 4, !tbaa !8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i32, ptr %ptype.addr, align 4, !tbaa !8
...
if.then2:                                         ; preds = %if.end
  ...
  %5 = load ptr, ptr %priv_key3, align 8, !tbaa !26
  store ptr %5, ptr %priv_key, align 8, !tbaa !4
  br label %if.end4

if.else:                                          ; preds = %if.end
  store ptr null, ptr %priv_key, align 8, !tbaa !4
  br label %if.end4

if.end4:                                          ; preds = %if.else, %if.then2
  %6 = load i32, ptr %ptype.addr, align 4, !tbaa !8
...
if.then6:                                         ; preds = %if.end4
  ...
  %8 = load ptr, ptr %pub_key7, align 8, !tbaa !14
  store ptr %8, ptr %pub_key, align 8, !tbaa !4
  br label %if.end9
...
if.end9:                                          ; preds = %if.else8, %if.then6
  %9 = load i32, ptr %ptype.addr, align 4, !tbaa !8
  %cmp10 = icmp eq i32 %9, 2
  br i1 %cmp10, label %if.then11, label %if.else12

if.then11:                                        ; preds = %if.end9
  store ptr @.str.3, ptr %ktype, align 8, !tbaa !4
  br label %if.end17

if.else12:                                        ; preds = %if.end9
  %10 = load i32, ptr %ptype.addr, align 4, !tbaa !8
  %cmp13 = icmp eq i32 %10, 1
  br i1 %cmp13, label %if.then14, label %if.else15

if.then14:                                        ; preds = %if.else12
  store ptr @.str.4, ptr %ktype, align 8, !tbaa !4
  br label %if.end16

if.else15:                                        ; preds = %if.else12
  store ptr @.str.5, ptr %ktype, align 8, !tbaa !4
  br label %if.end16
...
if.end17:                                         ; preds = %if.end16, %if.then11
  %11 = load ptr, ptr %priv_key, align 8, !tbaa !4
  %cmp18 = icmp ne ptr %11, null
  br i1 %cmp18, label %if.then19, label %if.else27

if.then19:                                        ; preds = %if.end17
  %12 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %13 = load i32, ptr %off.addr, align 4, !tbaa !8
...
if.end22:                                         ; preds = %if.then19
  %14 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %15 = load ptr, ptr %ktype, align 8, !tbaa !4
  %16 = load i32, ptr %mod_len, align 4, !tbaa !8
...
if.else27:                                        ; preds = %if.end17
  %17 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %18 = load i32, ptr %mod_len, align 4, !tbaa !8
...
if.end32:                                         ; preds = %if.end31, %if.end26
  %19 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %20 = load ptr, ptr %priv_key, align 8, !tbaa !4
  %21 = load i32, ptr %off.addr, align 4, !tbaa !8
...
if.end36:                                         ; preds = %if.end32
  %22 = load ptr, ptr %bp.addr, align 8, !tbaa !4
  %23 = load ptr, ptr %pub_key, align 8, !tbaa !4
  %24 = load i32, ptr %off.addr, align 4, !tbaa !8
...
err:                                              ; preds = %if.end45, %if.then44, %if.then39, %if.then35, %if.then30, %if.then25, %if.then21
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %mod_len) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %pub_key) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %priv_key) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %ktype) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %ret) #3
  ret i32 %28
}
...
!13 = !{!11, !9, i64 0}
!14 = !{!15, !5, i64 104}
!15 = !{!"dsa_st", !9, i64 0, !9, i64 4, !16, i64 8, !5, i64 104, !5, i64 112, !9, i64 120, !5, i64 128, !6, i64 136, !17, i64 144, !5, i64 160, !5, i64 168, !5, i64 176, !5, i64 184, !12, i64 192}
!16 = !{!"ffc_params_st", !5, i64 0, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !12, i64 40, !9, i64 48, !9, i64 52, !9, i64 56, !9, i64 60, !9, i64 64, !5, i64 72, !5, i64 80, !9, i64 88}
...
!28 = !{!12, !12, i64 0}
!29 = !{!30, !5, i64 8}
!30 = !{!"evp_pkey_ctx_st", !9, i64 0, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !6, i64 40, !31, i64 56, !5, i64 88, !5, i64 96, !5, i64 104, !9, i64 112, !9, i64 116, !5, i64 120, !5, i64 128, !5, i64 136, !5, i64 144, !5, i64 152, !9, i64 160, !5, i64 168}
!31 = !{!"", !5, i64 0, !5, i64 8, !12, i64 16, !9, i64 24}
