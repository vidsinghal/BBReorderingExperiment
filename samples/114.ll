; ModuleID = 'samples/114.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/base/flamec/util/base/transpose/FLA_Transpose_blk_var2.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.FLA_Obj_view = type { i64, i64, i64, i64, i64, i64, ptr }
%struct.fla_tpose_s = type { i32, i32, ptr, ptr, ptr }

; Function Attrs: nounwind uwtable
define i32 @FLA_Transpose_blk_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef %cntl) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %blocksize = getelementptr inbounds %struct.fla_tpose_s, ptr %0, i32 0, i32 2
  ...
  %call5 = call i32 @FLA_Transpose_unb_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11)
  %4 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_swap = getelementptr inbounds %struct.fla_tpose_s, ptr %4, i32 0, i32 4
  %5 = load ptr, ptr %sub_swap, align 8, !tbaa !13
  %call6 = call i32 @FLA_Swap_t_blk_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A21, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A12, ptr noundef %5)
...
declare i32 @FLA_Transpose_unb_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8) #2

declare i32 @FLA_Swap_t_blk_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef) #2
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !5, i64 8}
!9 = !{!"fla_tpose_s", !10, i64 0, !10, i64 4, !5, i64 8, !5, i64 16, !5, i64 24}
!10 = !{!"int", !6, i64 0}
!11 = !{!12, !12, i64 0}
!12 = !{!"long", !6, i64 0}
!13 = !{!9, !5, i64 24}
