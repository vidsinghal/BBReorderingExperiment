; ModuleID = 'samples/889.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/blas/3/hemm/lu/flamec/FLA_Hemm_lu_blk_var8.c"
...
define i32 @FLA_Hemm_lu_blk_var8(ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C, ptr noundef %cntl) #0 {
entry:
  ...
  %sub_scal = getelementptr inbounds %struct.fla_hemm_s, ptr %0, i32 0, i32 3
  ...
  %call3 = call i32 @FLA_Part_2x1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %C, ptr noundef %CT, ptr noundef %CB, i64 noundef 0, i32 noundef 201)
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %call4 = call i64 @FLA_Obj_length(ptr noundef byval(%struct.FLA_Obj_view) align 8 %ABR)
...
while.body:                                       ; preds = %while.cond
  ...
  %blocksize = getelementptr inbounds %struct.fla_hemm_s, ptr %2, i32 0, i32 2
  %3 = load ptr, ptr %blocksize, align 8, !tbaa !11
  %call6 = call i64 @FLA_Determine_blocksize(ptr noundef byval(%struct.FLA_Obj_view) align 8 %ATL, i32 noundef 11, ptr noundef %3)
  ...
  %call8 = call i32 @FLA_Repart_2x1_to_3x1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %BT, ptr noundef %B0, ptr noundef %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 %BB, ptr noundef %B2, i64 noundef %6, i32 noundef 200)
  %7 = load i64, ptr %b, align 8, !tbaa !12
  %call9 = call i32 @FLA_Repart_2x1_to_3x1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %CT, ptr noundef %C0, ptr noundef %C1, ptr noundef byval(%struct.FLA_Obj_view) align 8 %CB, ptr noundef %C2, i64 noundef %7, i32 noundef 200)
  %8 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_gemm1 = getelementptr inbounds %struct.fla_hemm_s, ptr %8, i32 0, i32 5
  %9 = load ptr, ptr %sub_gemm1, align 8, !tbaa !14
  %call10 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A01, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C0, ptr noundef %9)
  %10 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_hemm = getelementptr inbounds %struct.fla_hemm_s, ptr %10, i32 0, i32 4
  %11 = load ptr, ptr %sub_hemm, align 8, !tbaa !15
  %call11 = call i32 @FLA_Hemm_internal(i32 noundef 210, i32 noundef 301, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C1, ptr noundef %11)
  %12 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_gemm2 = getelementptr inbounds %struct.fla_hemm_s, ptr %12, i32 0, i32 6
  %13 = load ptr, ptr %sub_gemm2, align 8, !tbaa !16
  %call12 = call i32 @FLA_Gemm_internal(i32 noundef 402, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A12, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C2, ptr noundef %13)
  ...
  %call14 = call i32 @FLA_Cont_with_3x1_to_2x1(ptr noundef %BT, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef %BB, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B2, i32 noundef 201)
  %call15 = call i32 @FLA_Cont_with_3x1_to_2x1(ptr noundef %CT, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C1, ptr noundef %CB, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C2, i32 noundef 201)
...
declare i32 @FLA_Hemm_internal(i32 noundef, i32 noundef, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef) #2
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !5, i64 16}
!9 = !{!"fla_hemm_s", !10, i64 0, !10, i64 4, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !5, i64 40}
!10 = !{!"int", !6, i64 0}
!11 = !{!9, !5, i64 8}
!12 = !{!13, !13, i64 0}
!13 = !{!"long", !6, i64 0}
