...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp) #4
  call void @OSSL_PARAM_construct_int(ptr sret(%struct.ossl_param_st) align 8 %tmp, ptr noundef @.str, ptr noundef %gindex.addr)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %2, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp) #4
  %3 = load ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp1) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp1)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %3, ptr align 8 %tmp1, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp1) #4
...
cleanup:                                          ; preds = %if.end, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 80, ptr %params) #4
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %2 = load i32, ptr %operation, align 8, !tbaa !13
...
lor.lhs.false2:                                   ; preds = %lor.lhs.false
  ...
  %4 = load i32, ptr %operation3, align 8, !tbaa !13
...
if.end:                                           ; preds = %lor.lhs.false2, %lor.lhs.false
  ...
  %6 = load ptr, ptr %keymgmt, align 8, !tbaa !16
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %8 = load ptr, ptr %pmeth, align 8, !tbaa !17
  %pkey_id = getelementptr inbounds %struct.evp_pkey_method_st, ptr %8, i32 0, i32 0
  %9 = load i32, ptr %pkey_id, align 8, !tbaa !18
...
land.lhs.true7:                                   ; preds = %land.lhs.true
  ...
  %11 = load ptr, ptr %pmeth8, align 8, !tbaa !17
  %pkey_id9 = getelementptr inbounds %struct.evp_pkey_method_st, ptr %11, i32 0, i32 0
  %12 = load i32, ptr %pkey_id9, align 8, !tbaa !18
...
entry:
  ...
  store i64 %seedlen, ptr %seedlen.addr, align 8, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
...
if.end:                                           ; preds = %entry
  ...
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp) #4
  %3 = load ptr, ptr %seed.addr, align 8, !tbaa !4
  %4 = load i64, ptr %seedlen.addr, align 8, !tbaa !11
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp1) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp1)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %5, ptr align 8 %tmp1, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp1) #4
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %typ, ptr %typ.addr, align 4, !tbaa !8
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load i32, ptr %typ.addr, align 4, !tbaa !8
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %pbits, ptr %pbits.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
  ...
  %0 = load i32, ptr %pbits.addr, align 4, !tbaa !8
  %conv = sext i32 %0 to i64
  store i64 %conv, ptr %bits, align 8, !tbaa !11
  %1 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
if.then:                                          ; preds = %entry
  %2 = load i32, ptr %ret, align 4, !tbaa !8
  store i32 %2, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %3, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp) #4
  %4 = load ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp2) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp2)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %4, ptr align 8 %tmp2, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp2) #4
  %5 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
entry:
  ...
  %tmp2 = alloca %struct.ossl_param_st, align 8
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %qbits, ptr %qbits.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
  store ptr %arraydecay, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %bits2) #4
  %0 = load i32, ptr %qbits.addr, align 4, !tbaa !8
  %conv = sext i32 %0 to i64
  store i64 %conv, ptr %bits2, align 8, !tbaa !11
  %1 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call = call i32 @dh_paramgen_check(ptr noundef %1)
  store i32 %call, ptr %ret, align 4, !tbaa !8
  %cmp = icmp sle i32 %call, 0
...
cleanup:                                          ; preds = %if.end, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %bits2) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #4
  call void @llvm.lifetime.end.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %ret) #4
  %6 = load i32, ptr %retval, align 4
...
entry:
  ...
  %tmp1 = alloca %struct.ossl_param_st, align 8
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %gen, ptr %gen.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
...
entry:
  ...
  store i32 %gen, ptr %gen.addr, align 4, !tbaa !8
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load i32, ptr %gen.addr, align 4, !tbaa !8
...
entry:
  ...
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load i32, ptr %nid.addr, align 4, !tbaa !8
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %pad, ptr %pad.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 80, ptr %dh_pad_params) #4
  call void @llvm.lifetime.start.p0(i64 4, ptr %upad) #4
  %0 = load i32, ptr %pad.addr, align 4, !tbaa !8
  store i32 %0, ptr %upad, align 4, !tbaa !8
  %1 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %3 = load i32, ptr %operation, align 8, !tbaa !13
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %arrayidx, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp) #4
  %arrayidx2 = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %dh_pad_params, i64 0, i64 1
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp3) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp3)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %arrayidx2, ptr align 8 %tmp3, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp3) #4
  %4 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
cleanup:                                          ; preds = %if.end, %if.then
  call void @llvm.lifetime.end.p0(i64 4, ptr %upad) #4
  call void @llvm.lifetime.end.p0(i64 80, ptr %dh_pad_params) #4
  %5 = load i32, ptr %retval, align 4
  ret i32 %5
}
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %kdf, ptr %kdf.addr, align 4, !tbaa !8
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load i32, ptr %kdf.addr, align 4, !tbaa !8
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store ptr %oid, ptr %oid.addr, align 8, !tbaa !4
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load ptr, ptr %oid.addr, align 8, !tbaa !4
...
entry:
  ...
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load ptr, ptr %md.addr, align 8, !tbaa !4
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store ptr %pmd, ptr %pmd.addr, align 8, !tbaa !4
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %1 = load ptr, ptr %pmd.addr, align 8, !tbaa !4
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store i32 %outlen, ptr %outlen.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %len) #4
  %0 = load i32, ptr %outlen.addr, align 4, !tbaa !8
  %conv = sext i32 %0 to i64
  store i64 %conv, ptr %len, align 8, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
  store ptr %arraydecay, ptr %p, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  %4 = load i32, ptr %outlen.addr, align 4, !tbaa !8
...
if.end5:                                          ; preds = %if.end
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %5, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp) #4
  %6 = load ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp6) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp6)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %6, ptr align 8 %tmp6, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp6) #4
  %7 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %4 = load ptr, ptr %keymgmt, align 8, !tbaa !16
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %6 = load ptr, ptr %pmeth, align 8, !tbaa !17
  %pkey_id = getelementptr inbounds %struct.evp_pkey_method_st, ptr %6, i32 0, i32 0
  %7 = load i32, ptr %pkey_id, align 8, !tbaa !18
...
land.lhs.true4:                                   ; preds = %land.lhs.true
  ...
  %9 = load ptr, ptr %pmeth5, align 8, !tbaa !17
  %pkey_id6 = getelementptr inbounds %struct.evp_pkey_method_st, ptr %9, i32 0, i32 0
  %10 = load i32, ptr %pkey_id6, align 8, !tbaa !18
...
entry:
  ...
  %tmp1 = alloca %struct.ossl_param_st, align 8
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store ptr %plen, ptr %plen.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %len) #4
  store i64 4294967295, ptr %len, align 8, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
  store ptr %arraydecay, ptr %p, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp1) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp1)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %4, ptr align 8 %tmp1, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp1) #4
  %5 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %arraydecay2 = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
...
lor.lhs.false:                                    ; preds = %if.end6
  %8 = load i64, ptr %len, align 8, !tbaa !11
...
if.end10:                                         ; preds = %lor.lhs.false
  %9 = load i64, ptr %len, align 8, !tbaa !11
  %conv = trunc i64 %9 to i32
  %10 = load ptr, ptr %plen.addr, align 8, !tbaa !4
  store i32 %conv, ptr %10, align 4, !tbaa !8
  store i32 1, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup
...
entry:
  ...
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store ptr %ukm, ptr %ukm.addr, align 8, !tbaa !4
...
if.end3:                                          ; preds = %if.end
  ...
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp) #4
  %5 = load ptr, ptr %ukm.addr, align 8, !tbaa !4
  %6 = load i32, ptr %len.addr, align 4, !tbaa !8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %4, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp) #4
  %7 = load ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp4) #4
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp4)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %7, ptr align 8 %tmp4, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp4) #4
  %8 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  ...
  store i32 %call6, ptr %ret, align 4, !tbaa !8
  %9 = load i32, ptr %ret, align 4, !tbaa !8
...
if.then13:                                        ; preds = %if.end10
  %11 = load ptr, ptr %ukm.addr, align 8, !tbaa !4
...
entry:
  ...
  %tmp1 = alloca %struct.ossl_param_st, align 8
  store ptr %ctx, ptr %ctx.addr, align 8, !tbaa !4
  store ptr %pukm, ptr %pukm.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %ukmlen) #4
  call void @llvm.lifetime.start.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %p) #4
  %arraydecay = getelementptr inbounds [2 x %struct.ossl_param_st], ptr %params, i64 0, i64 0
  store ptr %arraydecay, ptr %p, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  ...
  store ptr %incdec.ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp) #4
  %4 = load ptr, ptr %pukm.addr, align 8, !tbaa !4
...
if.end9:                                          ; preds = %if.end6
  ...
  %9 = load i64, ptr %return_size, align 16, !tbaa !20
  store i64 %9, ptr %ukmlen, align 8, !tbaa !11
  %10 = load i64, ptr %ukmlen, align 8, !tbaa !11
...
if.end12:                                         ; preds = %if.end9
  %11 = load i64, ptr %ukmlen, align 8, !tbaa !11
  %conv = trunc i64 %11 to i32
  store i32 %conv, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end12, %if.then11, %if.then8, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #4
  call void @llvm.lifetime.end.p0(i64 80, ptr %params) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %ukmlen) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr %ret) #4
...
!12 = !{!"long", !6, i64 0}
!13 = !{!14, !9, i64 0}
!14 = !{!"evp_pkey_ctx_st", !9, i64 0, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !6, i64 40, !15, i64 56, !5, i64 88, !5, i64 96, !5, i64 104, !9, i64 112, !9, i64 116, !5, i64 120, !5, i64 128, !5, i64 136, !5, i64 144, !5, i64 152, !9, i64 160, !5, i64 168}
!15 = !{!"", !5, i64 0, !5, i64 8, !12, i64 16, !9, i64 24}
!16 = !{!14, !5, i64 32}
!17 = !{!14, !5, i64 120}
!18 = !{!19, !9, i64 0}
!19 = !{!"evp_pkey_method_st", !9, i64 0, !9, i64 4, !5, i64 8, !5, i64 16, !5, i64 24, !5, i64 32, !5, i64 40, !5, i64 48, !5, i64 56, !5, i64 64, !5, i64 72, !5, i64 80, !5, i64 88, !5, i64 96, !5, i64 104, !5, i64 112, !5, i64 120, !5, i64 128, !5, i64 136, !5, i64 144, !5, i64 152, !5, i64 160, !5, i64 168, !5, i64 176, !5, i64 184, !5, i64 192, !5, i64 200, !5, i64 208, !5, i64 216, !5, i64 224, !5, i64 232, !5, i64 240, !5, i64 248}
!20 = !{!21, !12, i64 32}
!21 = !{!"ossl_param_st", !5, i64 0, !9, i64 8, !5, i64 16, !12, i64 24, !12, i64 32}
