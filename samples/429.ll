; ModuleID = 'samples/429.bc'
source_filename = "/local-ssd/xnnpack-r7msi2beibvbxa3e6lvblom7qlyd5i24-build/aidengro/spack-stage-xnnpack-2022-02-16-r7msi2beibvbxa3e6lvblom7qlyd5i24/spack-src/src/f32-vrnd/gen/vrndd-avx-x16.c"
...
define hidden void @xnn_f32_vrndd_ukernel__avx_x16(i64 noundef %n, ptr noundef %x, ptr noundef %y, ptr noalias noundef align 16 dereferenceable(64) %params) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = call <8 x float> @llvm.x86.avx.round.ps.256(<8 x float> %4, i32 9)
  ...
  %7 = call <8 x float> @llvm.x86.avx.round.ps.256(<8 x float> %6, i32 9)
...
for.body7:                                        ; preds = %for.cond5
  ...
  %18 = call <8 x float> @llvm.x86.avx.round.ps.256(<8 x float> %17, i32 9)
...
if.then:                                          ; preds = %for.end13
  ...
  %31 = call <8 x float> @llvm.x86.avx.round.ps.256(<8 x float> %30, i32 9)
