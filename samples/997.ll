; ModuleID = 'samples/997.bc'
source_filename = "/local-ssd/libflame-e5nfvhftngyb7czajtt6ztnesna24ye7-build/aidengro/spack-stage-libflame-5.2.0-e5nfvhftngyb7czajtt6ztnesna24ye7/spack-src/src/blas/3/trmm/llt/flamec/FLA_Trmm_llt_unb_var3.c"
...
define i32 @FLA_Trmm_llt_unb_var3(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call5 = call i32 @FLA_Trmv_external(i32 noundef 300, i32 noundef 401, i32 noundef %0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1)
