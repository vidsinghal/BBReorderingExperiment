; ModuleID = 'samples/823.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/blas/3/trmm/luh/flamec/FLA_Trmm_luh_blk_var4.c"
...
define i32 @FLA_Trmm_luh_blk_var4(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef %cntl) #0 {
entry:
...
while.cond:                                       ; preds = %while.body, %entry
  %call1 = call i64 @FLA_Obj_width(ptr noundef byval(%struct.FLA_Obj_view) align 8 %BR)
  %call2 = call i64 @FLA_Obj_width(ptr noundef byval(%struct.FLA_Obj_view) align 8 %B)
...
while.body:                                       ; preds = %while.cond
  ...
  %call3 = call i64 @FLA_Determine_blocksize(ptr noundef byval(%struct.FLA_Obj_view) align 8 %BL, i32 noundef 210, ptr noundef %1)
  store i64 %call3, ptr %b, align 8, !tbaa !12
  %2 = load i64, ptr %b, align 8, !tbaa !12
  %call4 = call i32 @FLA_Repart_1x2_to_1x3(ptr noundef byval(%struct.FLA_Obj_view) align 8 %BL, ptr noundef byval(%struct.FLA_Obj_view) align 8 %BR, ptr noundef %B0, ptr noundef %B1, ptr noundef %B2, i64 noundef %2, i32 noundef 210)
  %3 = load i32, ptr %diagA.addr, align 4, !tbaa !4
  %4 = load ptr, ptr %cntl.addr, align 8, !tbaa !8
  %sub_trmm = getelementptr inbounds %struct.fla_trmm_s, ptr %4, i32 0, i32 4
  %5 = load ptr, ptr %sub_trmm, align 8, !tbaa !14
  %call5 = call i32 @FLA_Trmm_internal(i32 noundef 210, i32 noundef 301, i32 noundef 402, i32 noundef %3, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef %5)
...
!10 = !{!11, !9, i64 8}
!11 = !{!"fla_trmm_s", !5, i64 0, !5, i64 4, !9, i64 8, !9, i64 16, !9, i64 24, !9, i64 32}
!12 = !{!13, !13, i64 0}
!13 = !{!"long", !6, i64 0}
!14 = !{!11, !9, i64 24}
!15 = distinct !{!15, !16}
