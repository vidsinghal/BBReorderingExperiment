; ModuleID = 'samples/805.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/map/lapack2flamec/f2c/c/ztplqt.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.doublecomplex = type { double, double }

@.str = private unnamed_addr constant [7 x i8] c"ZTPLQT\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c"R\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"N\00", align 1
@.str.3 = private unnamed_addr constant [2 x i8] c"F\00", align 1

; Function Attrs: nounwind uwtable
define i32 @ztplqt_(ptr noundef %m, ptr noundef %n, ptr noundef %l, ptr noundef %mb, ptr noundef %a, ptr noundef %lda, ptr noundef %b, ptr noundef %ldb, ptr noundef %t, ptr noundef %ldt, ptr noundef %work, ptr noundef %info) #0 {
entry:
...
if.else54:                                        ; preds = %cond.end50
  ...
  %77 = load ptr, ptr %mb.addr, align 8, !tbaa !4
...
if.end70:                                         ; preds = %lor.lhs.false67
  ...
  %90 = load ptr, ptr %mb.addr, align 8, !tbaa !4
...
for.body:                                         ; preds = %cond.end77
  %97 = load ptr, ptr %m.addr, align 8, !tbaa !4
  ...
  %101 = load ptr, ptr %mb.addr, align 8, !tbaa !4
...
cond.end101:                                      ; preds = %cond.false100, %cond.true99
  ...
  store i32 %121, ptr %nb, align 4, !tbaa !8
...
if.else106:                                       ; preds = %cond.end101
  %125 = load i32, ptr %nb, align 4, !tbaa !8
...
if.end111:                                        ; preds = %if.else106, %if.then105
  ...
  %add113 = add nsw i32 %137, %138
  %idxprom114 = sext i32 %add113 to i64
  %arrayidx115 = getelementptr inbounds %struct.doublecomplex, ptr %136, i64 %idxprom114
  ...
  %mul116 = mul nsw i32 %141, %142
  %add117 = add nsw i32 %mul116, 1
  %idxprom118 = sext i32 %add117 to i64
  %arrayidx119 = getelementptr inbounds %struct.doublecomplex, ptr %140, i64 %idxprom118
  %143 = load ptr, ptr %ldt.addr, align 8, !tbaa !4
  %call120 = call i32 @ztplqt2_(ptr noundef %ib, ptr noundef %nb, ptr noundef %lb, ptr noundef %arrayidx, ptr noundef %135, ptr noundef %arrayidx115, ptr noundef %139, ptr noundef %arrayidx119, ptr noundef %143, ptr noundef %iinfo)
  %144 = load i32, ptr %i__, align 4, !tbaa !8
  %145 = load i32, ptr %ib, align 4, !tbaa !8
  %add121 = add nsw i32 %144, %145
  %146 = load ptr, ptr %m.addr, align 8, !tbaa !4
  %147 = load i32, ptr %146, align 4, !tbaa !8
  %cmp122 = icmp sle i32 %add121, %147
  br i1 %cmp122, label %if.then124, label %if.end149

if.then124:                                       ; preds = %if.end111
  %148 = load ptr, ptr %m.addr, align 8, !tbaa !4
  %149 = load i32, ptr %148, align 4, !tbaa !8
  %150 = load i32, ptr %i__, align 4, !tbaa !8
  %sub125 = sub nsw i32 %149, %150
  %151 = load i32, ptr %ib, align 4, !tbaa !8
  %sub126 = sub nsw i32 %sub125, %151
  %add127 = add nsw i32 %sub126, 1
  store i32 %add127, ptr %i__3, align 4, !tbaa !8
  %152 = load ptr, ptr %m.addr, align 8, !tbaa !4
  %153 = load i32, ptr %152, align 4, !tbaa !8
  %154 = load i32, ptr %i__, align 4, !tbaa !8
  %sub128 = sub nsw i32 %153, %154
  %155 = load i32, ptr %ib, align 4, !tbaa !8
  %sub129 = sub nsw i32 %sub128, %155
  %add130 = add nsw i32 %sub129, 1
  store i32 %add130, ptr %i__4, align 4, !tbaa !8
  %156 = load ptr, ptr %b.addr, align 8, !tbaa !4
  %157 = load i32, ptr %i__, align 4, !tbaa !8
  %158 = load i32, ptr %b_dim1, align 4, !tbaa !8
  %add131 = add nsw i32 %157, %158
  %idxprom132 = sext i32 %add131 to i64
  %arrayidx133 = getelementptr inbounds %struct.doublecomplex, ptr %156, i64 %idxprom132
  %159 = load ptr, ptr %ldb.addr, align 8, !tbaa !4
  %160 = load ptr, ptr %t.addr, align 8, !tbaa !4
  %161 = load i32, ptr %i__, align 4, !tbaa !8
  %162 = load i32, ptr %t_dim1, align 4, !tbaa !8
  %mul134 = mul nsw i32 %161, %162
  %add135 = add nsw i32 %mul134, 1
  %idxprom136 = sext i32 %add135 to i64
  %arrayidx137 = getelementptr inbounds %struct.doublecomplex, ptr %160, i64 %idxprom136
  %163 = load ptr, ptr %ldt.addr, align 8, !tbaa !4
  %164 = load ptr, ptr %a.addr, align 8, !tbaa !4
  %165 = load i32, ptr %i__, align 4, !tbaa !8
  %166 = load i32, ptr %ib, align 4, !tbaa !8
  %add138 = add nsw i32 %165, %166
  %167 = load i32, ptr %i__, align 4, !tbaa !8
  %168 = load i32, ptr %a_dim1, align 4, !tbaa !8
  %mul139 = mul nsw i32 %167, %168
  %add140 = add nsw i32 %add138, %mul139
  %idxprom141 = sext i32 %add140 to i64
  %arrayidx142 = getelementptr inbounds %struct.doublecomplex, ptr %164, i64 %idxprom141
  %169 = load ptr, ptr %lda.addr, align 8, !tbaa !4
  %170 = load ptr, ptr %b.addr, align 8, !tbaa !4
  %171 = load i32, ptr %i__, align 4, !tbaa !8
  %172 = load i32, ptr %ib, align 4, !tbaa !8
  %add143 = add nsw i32 %171, %172
  %173 = load i32, ptr %b_dim1, align 4, !tbaa !8
  %add144 = add nsw i32 %add143, %173
  %idxprom145 = sext i32 %add144 to i64
  %arrayidx146 = getelementptr inbounds %struct.doublecomplex, ptr %170, i64 %idxprom145
  %174 = load ptr, ptr %ldb.addr, align 8, !tbaa !4
  %175 = load ptr, ptr %work.addr, align 8, !tbaa !4
  %arrayidx147 = getelementptr inbounds %struct.doublecomplex, ptr %175, i64 1
  %call148 = call i32 @ztprfb_(ptr noundef @.str.1, ptr noundef @.str.2, ptr noundef @.str.3, ptr noundef @.str.1, ptr noundef %i__3, ptr noundef %nb, ptr noundef %ib, ptr noundef %lb, ptr noundef %arrayidx133, ptr noundef %159, ptr noundef %arrayidx137, ptr noundef %163, ptr noundef %arrayidx142, ptr noundef %169, ptr noundef %arrayidx146, ptr noundef %174, ptr noundef %arrayidx147, ptr noundef %i__4)
  br label %if.end149

if.end149:                                        ; preds = %if.then124, %if.end111
  br label %for.inc

for.inc:                                          ; preds = %if.end149
  %176 = load i32, ptr %i__2, align 4, !tbaa !8
  %177 = load i32, ptr %i__, align 4, !tbaa !8
  %add150 = add nsw i32 %177, %176
...
declare i32 @ztplqt2_(ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) #2
