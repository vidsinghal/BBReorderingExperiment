; ModuleID = 'samples/447.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/lapack/sol/sylv/nh/flamec/FLA_Sylv_nh_blk_var1.c"
...
define i32 @FLA_Sylv_nh_blk_var1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %isgn, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C, ptr noundef byval(%struct.FLA_Obj_view) align 8 %scale, ptr noundef %cntl) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %9 = load ptr, ptr %sub_gemm1, align 8, !tbaa !13
  %call9 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A12, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C22, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C12, ptr noundef %9)
  %10 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_sylv1 = getelementptr inbounds %struct.fla_sylv_s, ptr %10, i32 0, i32 3
  %11 = load ptr, ptr %sub_sylv1, align 8, !tbaa !14
  %call10 = call i32 @FLA_Sylv_internal(i32 noundef 400, i32 noundef 402, ptr noundef byval(%struct.FLA_Obj_view) align 8 %isgn, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B22, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C12, ptr noundef byval(%struct.FLA_Obj_view) align 8 %scale, ptr noundef %11)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call12 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 402, ptr noundef byval(%struct.FLA_Obj_view) align 8 %agg.tmp, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C22, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B12, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C21, ptr noundef %15)
  ...
  %call13 = call i32 @FLA_Sylv_internal(i32 noundef 400, i32 noundef 402, ptr noundef byval(%struct.FLA_Obj_view) align 8 %isgn, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A22, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C21, ptr noundef byval(%struct.FLA_Obj_view) align 8 %scale, ptr noundef %17)
  call void @llvm.lifetime.start.p0(i64 56, ptr %agg.tmp14) #4
  %base15 = getelementptr inbounds %struct.FLA_Obj_view, ptr %isgn, i32 0, i32 6
  %18 = load ptr, ptr %base15, align 8, !tbaa !15
  %19 = load ptr, ptr getelementptr inbounds (%struct.FLA_Obj_view, ptr @FLA_ONE, i32 0, i32 6), align 8, !tbaa !15
  %cmp16 = icmp eq ptr %18, %19
  br i1 %cmp16, label %cond.true17, label %cond.false18

cond.true17:                                      ; preds = %cond.end
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %agg.tmp14, ptr align 8 @FLA_MINUS_ONE, i64 56, i1 false), !tbaa.struct !17
  br label %cond.end19

cond.false18:                                     ; preds = %cond.end
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %agg.tmp14, ptr align 8 @FLA_ONE, i64 56, i1 false), !tbaa.struct !17
  br label %cond.end19

cond.end19:                                       ; preds = %cond.false18, %cond.true17
  %20 = load ptr, ptr %cntl.addr, align 8, !tbaa !4
  %sub_gemm3 = getelementptr inbounds %struct.fla_sylv_s, ptr %20, i32 0, i32 8
  %21 = load ptr, ptr %sub_gemm3, align 8, !tbaa !20
  %call20 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 402, ptr noundef byval(%struct.FLA_Obj_view) align 8 %agg.tmp14, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C12, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B12, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C11, ptr noundef %21)
  call void @llvm.lifetime.end.p0(i64 56, ptr %agg.tmp14) #4
