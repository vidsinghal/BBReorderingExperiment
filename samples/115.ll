; ModuleID = 'samples/115.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/blas/3/trmm/lut/flamec/FLA_Trmm_lut_unb_var2.c"
...
define i32 @FLA_Trmm_lut_unb_var2(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call7 = call i32 @FLA_Ger_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a12t, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1t, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B2)
  %0 = load i32, ptr %diagA.addr, align 4, !tbaa !4
  %cmp8 = icmp ne i32 %0, 500
  br i1 %cmp8, label %if.then, label %if.end

if.then:                                          ; preds = %while.body
  %call9 = call i32 @FLA_Scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1t)
  br label %if.end
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %call11 = call i32 @FLA_Cont_with_3x1_to_2x1(ptr noundef %BT, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1t, ptr noundef %BB, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B2, i32 noundef 201)
