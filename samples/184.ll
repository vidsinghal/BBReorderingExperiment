...
@OCSP_crl_reason_str.reason_tbl = internal constant [8 x %struct.OCSP_TBLSTR] [%struct.OCSP_TBLSTR { i64 0, ptr @.str.9 }, %struct.OCSP_TBLSTR { i64 1, ptr @.str.10 }, %struct.OCSP_TBLSTR { i64 2, ptr @.str.11 }, %struct.OCSP_TBLSTR { i64 3, ptr @.str.12 }, %struct.OCSP_TBLSTR { i64 4, ptr @.str.13 }, %struct.OCSP_TBLSTR { i64 5, ptr @.str.14 }, %struct.OCSP_TBLSTR { i64 6, ptr @.str.15 }, %struct.OCSP_TBLSTR { i64 8, ptr @.str.16 }], align 16
...
entry:
  ...
  store i64 %s, ptr %s.addr, align 8, !tbaa !4
  %0 = load i64, ptr %s.addr, align 8, !tbaa !4
...
entry:
  ...
  store i64 %s, ptr %s.addr, align 8, !tbaa !4
  store ptr %ts, ptr %ts.addr, align 8, !tbaa !8
  store i64 %len, ptr %len.addr, align 8, !tbaa !4
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %1 = load i64, ptr %len.addr, align 8, !tbaa !4
  %cmp = icmp ult i64 %0, %1
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %2 = load ptr, ptr %ts.addr, align 8, !tbaa !8
  %t = getelementptr inbounds %struct.OCSP_TBLSTR, ptr %2, i32 0, i32 0
  %3 = load i64, ptr %t, align 8, !tbaa !10
  %4 = load i64, ptr %s.addr, align 8, !tbaa !4
  %cmp1 = icmp eq i64 %3, %4
  br i1 %cmp1, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %5 = load ptr, ptr %ts.addr, align 8, !tbaa !8
  %m = getelementptr inbounds %struct.OCSP_TBLSTR, ptr %5, i32 0, i32 1
  %6 = load ptr, ptr %m, align 8, !tbaa !12
...
for.inc:                                          ; preds = %if.end
  ...
  %8 = load ptr, ptr %ts.addr, align 8, !tbaa !8
  %incdec.ptr = getelementptr inbounds %struct.OCSP_TBLSTR, ptr %8, i32 1
  store ptr %incdec.ptr, ptr %ts.addr, align 8, !tbaa !8
...
entry:
  ...
  store i64 %s, ptr %s.addr, align 8, !tbaa !4
  %0 = load i64, ptr %s.addr, align 8, !tbaa !4
  %call = call ptr @do_table2string(i64 noundef %0, ptr noundef @OCSP_crl_reason_str.reason_tbl, i64 noundef 8)
  ret ptr %call
}
...
entry:
  ...
  store ptr %o, ptr %o.addr, align 8, !tbaa !8
  store i64 %flags, ptr %flags.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %l) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %cid) #4
  store ptr null, ptr %cid, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %one) #4
  store ptr null, ptr %one, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %inf) #4
  %0 = load ptr, ptr %o.addr, align 8, !tbaa !8
  %tbsRequest = getelementptr inbounds %struct.ocsp_request_st, ptr %0, i32 0, i32 0
  store ptr %tbsRequest, ptr %inf, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %sig) #4
  %1 = load ptr, ptr %o.addr, align 8, !tbaa !8
  %optionalSignature = getelementptr inbounds %struct.ocsp_request_st, ptr %1, i32 0, i32 1
  %2 = load ptr, ptr %optionalSignature, align 8, !tbaa !15
  store ptr %2, ptr %sig, align 8, !tbaa !8
  %3 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call = call i32 @BIO_write(ptr noundef %3, ptr noundef @.str.17, i32 noundef 19)
...
if.end:                                           ; preds = %entry
  %4 = load ptr, ptr %inf, align 8, !tbaa !8
  %version = getelementptr inbounds %struct.ocsp_req_info_st, ptr %4, i32 0, i32 0
  %5 = load ptr, ptr %version, align 8, !tbaa !18
  %call1 = call i64 @ASN1_INTEGER_get(ptr noundef %5)
  store i64 %call1, ptr %l, align 8, !tbaa !4
  %6 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %7 = load i64, ptr %l, align 8, !tbaa !4
  %add = add nsw i64 %7, 1
  %8 = load i64, ptr %l, align 8, !tbaa !4
  %call2 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %6, ptr noundef @.str.18, i64 noundef %add, i64 noundef %8)
...
if.end5:                                          ; preds = %if.end
  %9 = load ptr, ptr %inf, align 8, !tbaa !8
  %requestorName = getelementptr inbounds %struct.ocsp_req_info_st, ptr %9, i32 0, i32 1
  %10 = load ptr, ptr %requestorName, align 8, !tbaa !19
  %cmp6 = icmp ne ptr %10, null
  br i1 %cmp6, label %if.then7, label %if.end14

if.then7:                                         ; preds = %if.end5
  %11 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call8 = call i32 @BIO_write(ptr noundef %11, ptr noundef @.str.19, i32 noundef 21)
...
if.end11:                                         ; preds = %if.then7
  %12 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %13 = load ptr, ptr %inf, align 8, !tbaa !8
  %requestorName12 = getelementptr inbounds %struct.ocsp_req_info_st, ptr %13, i32 0, i32 1
  %14 = load ptr, ptr %requestorName12, align 8, !tbaa !19
  %call13 = call i32 @GENERAL_NAME_print(ptr noundef %12, ptr noundef %14)
  br label %if.end14

if.end14:                                         ; preds = %if.end11, %if.end5
  %15 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call15 = call i32 @BIO_write(ptr noundef %15, ptr noundef @.str.20, i32 noundef 21)
...
for.cond:                                         ; preds = %for.inc, %if.end18
  %16 = load i32, ptr %i, align 4, !tbaa !20
  %17 = load ptr, ptr %inf, align 8, !tbaa !8
  %requestList = getelementptr inbounds %struct.ocsp_req_info_st, ptr %17, i32 0, i32 2
  %18 = load ptr, ptr %requestList, align 8, !tbaa !22
...
for.body:                                         ; preds = %for.cond
  ...
  %28 = load ptr, ptr %singleRequestExtensions, align 8, !tbaa !25
  %29 = load i64, ptr %flags.addr, align 8, !tbaa !4
  %call26 = call i32 @X509V3_extensions_print(ptr noundef %26, ptr noundef @.str.21, ptr noundef %28, i64 noundef %29, i32 noundef 8)
...
for.inc:                                          ; preds = %if.end28
  %30 = load i32, ptr %i, align 4, !tbaa !20
  %inc = add nsw i32 %30, 1
  store i32 %inc, ptr %i, align 4, !tbaa !20
  br label %for.cond, !llvm.loop !26

for.end:                                          ; preds = %for.cond
  %31 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %32 = load ptr, ptr %inf, align 8, !tbaa !8
  %requestExtensions = getelementptr inbounds %struct.ocsp_req_info_st, ptr %32, i32 0, i32 3
  %33 = load ptr, ptr %requestExtensions, align 8, !tbaa !27
  %34 = load i64, ptr %flags.addr, align 8, !tbaa !4
  %call29 = call i32 @X509V3_extensions_print(ptr noundef %31, ptr noundef @.str.22, ptr noundef %33, i64 noundef %34, i32 noundef 4)
...
for.cond36:                                       ; preds = %for.inc49, %if.then34
  %40 = load i32, ptr %i, align 4, !tbaa !20
  %41 = load ptr, ptr %sig, align 8, !tbaa !8
  %certs = getelementptr inbounds %struct.ocsp_signature_st, ptr %41, i32 0, i32 2
  %42 = load ptr, ptr %certs, align 8, !tbaa !31
...
for.body40:                                       ; preds = %for.cond36
  %43 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %44 = load ptr, ptr %sig, align 8, !tbaa !8
  %certs41 = getelementptr inbounds %struct.ocsp_signature_st, ptr %44, i32 0, i32 2
  %45 = load ptr, ptr %certs41, align 8, !tbaa !31
  %call42 = call ptr @ossl_check_const_X509_sk_type(ptr noundef %45)
  %46 = load i32, ptr %i, align 4, !tbaa !20
  ...
  %47 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %48 = load ptr, ptr %sig, align 8, !tbaa !8
  %certs45 = getelementptr inbounds %struct.ocsp_signature_st, ptr %48, i32 0, i32 2
  %49 = load ptr, ptr %certs45, align 8, !tbaa !31
  %call46 = call ptr @ossl_check_const_X509_sk_type(ptr noundef %49)
  %50 = load i32, ptr %i, align 4, !tbaa !20
...
for.inc49:                                        ; preds = %for.body40
  %51 = load i32, ptr %i, align 4, !tbaa !20
...
cleanup:                                          ; preds = %err, %if.end52
  call void @llvm.lifetime.end.p0(i64 8, ptr %sig) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %inf) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %one) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %cid) #4
...
define internal ptr @ossl_check_const_OCSP_ONEREQ_sk_type(ptr noundef %sk) #3 {
entry:
  %sk.addr = alloca ptr, align 8
  store ptr %sk, ptr %sk.addr, align 8, !tbaa !8
  %0 = load ptr, ptr %sk.addr, align 8, !tbaa !8
  ret ptr %0
}
...
entry:
  ...
  store i32 %indent, ptr %indent.addr, align 4, !tbaa !20
  %0 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %1 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %call = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %0, ptr noundef @.str.40, i32 noundef %1, ptr noundef @.str.41)
  %2 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %add = add nsw i32 %2, 2
  store i32 %add, ptr %indent.addr, align 4, !tbaa !20
  %3 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %4 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %call1 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %3, ptr noundef @.str.42, i32 noundef %4, ptr noundef @.str.41)
  %5 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  ...
  %7 = load ptr, ptr %algorithm, align 8, !tbaa !33
  %call2 = call i32 @i2a_ASN1_OBJECT(ptr noundef %5, ptr noundef %7)
  %8 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %9 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %call3 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %8, ptr noundef @.str.43, i32 noundef %9, ptr noundef @.str.41)
  %10 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  ...
  %12 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %13 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %call5 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %12, ptr noundef @.str.44, i32 noundef %13, ptr noundef @.str.41)
  %14 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  ...
  %16 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %17 = load i32, ptr %indent.addr, align 4, !tbaa !20
  %call7 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %16, ptr noundef @.str.45, i32 noundef %17, ptr noundef @.str.41)
  %18 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  ...
  %20 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call9 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %20, ptr noundef @.str.36)
  ret i32 1
}
...
entry:
  ...
  store i32 0, ptr %ret, align 4, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %l) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr %cid) #4
  store ptr null, ptr %cid, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %br) #4
  store ptr null, ptr %br, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %rid) #4
  store ptr null, ptr %rid, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %rd) #4
  store ptr null, ptr %rd, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %cst) #4
  store ptr null, ptr %cst, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %rev) #4
  store ptr null, ptr %rev, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %single) #4
  store ptr null, ptr %single, align 8, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %rb) #4
  %0 = load ptr, ptr %o.addr, align 8, !tbaa !8
  %responseBytes = getelementptr inbounds %struct.ocsp_response_st, ptr %0, i32 0, i32 1
  %1 = load ptr, ptr %responseBytes, align 8, !tbaa !36
  store ptr %1, ptr %rb, align 8, !tbaa !8
  %2 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call = call i32 @BIO_puts(ptr noundef %2, ptr noundef @.str.23)
  %cmp = icmp sle i32 %call, 0
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %entry
  %3 = load ptr, ptr %o.addr, align 8, !tbaa !8
  %responseStatus = getelementptr inbounds %struct.ocsp_response_st, ptr %3, i32 0, i32 0
  %4 = load ptr, ptr %responseStatus, align 8, !tbaa !38
  ...
  %7 = load i64, ptr %l, align 8, !tbaa !4
  %call3 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %5, ptr noundef @.str.24, ptr noundef %call2, i64 noundef %7)
...
if.end6:                                          ; preds = %if.end
  %8 = load ptr, ptr %rb, align 8, !tbaa !8
...
if.end9:                                          ; preds = %if.end6
  %9 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call10 = call i32 @BIO_puts(ptr noundef %9, ptr noundef @.str.25)
...
if.then21:                                        ; preds = %if.end17
  %15 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call22 = call i32 @BIO_puts(ptr noundef %15, ptr noundef @.str.26)
  store i32 1, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

if.end23:                                         ; preds = %if.end17
  %16 = load ptr, ptr %o.addr, align 8, !tbaa !8
  %call24 = call ptr @OCSP_response_get1_basic(ptr noundef %16)
  store ptr %call24, ptr %br, align 8, !tbaa !8
...
if.end27:                                         ; preds = %if.end23
  %17 = load ptr, ptr %br, align 8, !tbaa !8
  %tbsResponseData = getelementptr inbounds %struct.ocsp_basic_response_st, ptr %17, i32 0, i32 0
  store ptr %tbsResponseData, ptr %rd, align 8, !tbaa !8
  %18 = load ptr, ptr %rd, align 8, !tbaa !8
  %version = getelementptr inbounds %struct.ocsp_response_data_st, ptr %18, i32 0, i32 0
  %19 = load ptr, ptr %version, align 8, !tbaa !41
  %call28 = call i64 @ASN1_INTEGER_get(ptr noundef %19)
  store i64 %call28, ptr %l, align 8, !tbaa !4
  %20 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %21 = load i64, ptr %l, align 8, !tbaa !4
  %add = add nsw i64 %21, 1
  %22 = load i64, ptr %l, align 8, !tbaa !4
  %call29 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %20, ptr noundef @.str.27, i64 noundef %add, i64 noundef %22)
...
if.end32:                                         ; preds = %if.end27
  %23 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call33 = call i32 @BIO_puts(ptr noundef %23, ptr noundef @.str.28)
...
if.end44:                                         ; preds = %sw.epilog
  %34 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %35 = load ptr, ptr %rd, align 8, !tbaa !8
  %producedAt = getelementptr inbounds %struct.ocsp_response_data_st, ptr %35, i32 0, i32 2
  %36 = load ptr, ptr %producedAt, align 8, !tbaa !46
...
if.end47:                                         ; preds = %if.end44
  %37 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call48 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %37, ptr noundef @.str.30)
...
for.cond:                                         ; preds = %for.inc, %if.end51
  %38 = load i32, ptr %i, align 4, !tbaa !20
  %39 = load ptr, ptr %rd, align 8, !tbaa !8
  %responses = getelementptr inbounds %struct.ocsp_response_data_st, ptr %39, i32 0, i32 3
  %40 = load ptr, ptr %responses, align 8, !tbaa !47
...
if.end60:                                         ; preds = %for.body
  ...
  store ptr %call63, ptr %single, align 8, !tbaa !8
  %47 = load ptr, ptr %single, align 8, !tbaa !8
  %certId = getelementptr inbounds %struct.ocsp_single_response_st, ptr %47, i32 0, i32 0
  %48 = load ptr, ptr %certId, align 8, !tbaa !48
  store ptr %48, ptr %cid, align 8, !tbaa !8
  %49 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %50 = load ptr, ptr %cid, align 8, !tbaa !8
...
if.end67:                                         ; preds = %if.end60
  %51 = load ptr, ptr %single, align 8, !tbaa !8
  %certStatus = getelementptr inbounds %struct.ocsp_single_response_st, ptr %51, i32 0, i32 1
  %52 = load ptr, ptr %certStatus, align 8, !tbaa !50
  store ptr %52, ptr %cst, align 8, !tbaa !8
  %53 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %54 = load ptr, ptr %cst, align 8, !tbaa !8
  %type68 = getelementptr inbounds %struct.ocsp_cert_status_st, ptr %54, i32 0, i32 0
  %55 = load i32, ptr %type68, align 8, !tbaa !51
  %conv = sext i32 %55 to i64
  %call69 = call ptr @OCSP_cert_status_str(i64 noundef %conv)
  %call70 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %53, ptr noundef @.str.31, ptr noundef %call69)
...
if.end74:                                         ; preds = %if.end67
  %56 = load ptr, ptr %cst, align 8, !tbaa !8
  %type75 = getelementptr inbounds %struct.ocsp_cert_status_st, ptr %56, i32 0, i32 0
  %57 = load i32, ptr %type75, align 8, !tbaa !51
  %cmp76 = icmp eq i32 %57, 1
  br i1 %cmp76, label %if.then78, label %if.end100

if.then78:                                        ; preds = %if.end74
  %58 = load ptr, ptr %cst, align 8, !tbaa !8
  %value79 = getelementptr inbounds %struct.ocsp_cert_status_st, ptr %58, i32 0, i32 1
  %59 = load ptr, ptr %value79, align 8, !tbaa !45
  store ptr %59, ptr %rev, align 8, !tbaa !8
  %60 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call80 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %60, ptr noundef @.str.32)
...
if.end84:                                         ; preds = %if.then78
  %61 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %62 = load ptr, ptr %rev, align 8, !tbaa !8
  %revocationTime = getelementptr inbounds %struct.ocsp_revoked_info_st, ptr %62, i32 0, i32 0
  %63 = load ptr, ptr %revocationTime, align 8, !tbaa !53
...
if.end88:                                         ; preds = %if.end84
  %64 = load ptr, ptr %rev, align 8, !tbaa !8
  %revocationReason = getelementptr inbounds %struct.ocsp_revoked_info_st, ptr %64, i32 0, i32 1
  %65 = load ptr, ptr %revocationReason, align 8, !tbaa !55
  %tobool89 = icmp ne ptr %65, null
  br i1 %tobool89, label %if.then90, label %if.end99

if.then90:                                        ; preds = %if.end88
  %66 = load ptr, ptr %rev, align 8, !tbaa !8
  %revocationReason91 = getelementptr inbounds %struct.ocsp_revoked_info_st, ptr %66, i32 0, i32 1
  %67 = load ptr, ptr %revocationReason91, align 8, !tbaa !55
  %call92 = call i64 @ASN1_ENUMERATED_get(ptr noundef %67)
  store i64 %call92, ptr %l, align 8, !tbaa !4
  %68 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %69 = load i64, ptr %l, align 8, !tbaa !4
  %call93 = call ptr @OCSP_crl_reason_str(i64 noundef %69)
  %70 = load i64, ptr %l, align 8, !tbaa !4
  %call94 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %68, ptr noundef @.str.33, ptr noundef %call93, i64 noundef %70)
...
if.end100:                                        ; preds = %if.end99, %if.end74
  %71 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call101 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %71, ptr noundef @.str.34)
...
if.end105:                                        ; preds = %if.end100
  %72 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %73 = load ptr, ptr %single, align 8, !tbaa !8
  %thisUpdate = getelementptr inbounds %struct.ocsp_single_response_st, ptr %73, i32 0, i32 2
  %74 = load ptr, ptr %thisUpdate, align 8, !tbaa !56
...
if.end109:                                        ; preds = %if.end105
  %75 = load ptr, ptr %single, align 8, !tbaa !8
  %nextUpdate = getelementptr inbounds %struct.ocsp_single_response_st, ptr %75, i32 0, i32 3
  %76 = load ptr, ptr %nextUpdate, align 8, !tbaa !57
  %tobool110 = icmp ne ptr %76, null
  br i1 %tobool110, label %if.then111, label %if.end122

if.then111:                                       ; preds = %if.end109
  %77 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call112 = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %77, ptr noundef @.str.35)
...
if.end116:                                        ; preds = %if.then111
  %78 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %79 = load ptr, ptr %single, align 8, !tbaa !8
  %nextUpdate117 = getelementptr inbounds %struct.ocsp_single_response_st, ptr %79, i32 0, i32 3
  %80 = load ptr, ptr %nextUpdate117, align 8, !tbaa !57
...
if.end122:                                        ; preds = %if.end121, %if.end109
  %81 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call123 = call i32 @BIO_write(ptr noundef %81, ptr noundef @.str.36, i32 noundef 1)
...
if.end127:                                        ; preds = %if.end122
  %82 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %83 = load ptr, ptr %single, align 8, !tbaa !8
  %singleExtensions = getelementptr inbounds %struct.ocsp_single_response_st, ptr %83, i32 0, i32 4
  %84 = load ptr, ptr %singleExtensions, align 8, !tbaa !58
  %85 = load i64, ptr %flags.addr, align 8, !tbaa !4
  %call128 = call i32 @X509V3_extensions_print(ptr noundef %82, ptr noundef @.str.37, ptr noundef %84, i64 noundef %85, i32 noundef 8)
...
if.end131:                                        ; preds = %if.end127
  %86 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %call132 = call i32 @BIO_write(ptr noundef %86, ptr noundef @.str.36, i32 noundef 1)
...
for.inc:                                          ; preds = %if.end136, %if.then59
  %87 = load i32, ptr %i, align 4, !tbaa !20
  %inc = add nsw i32 %87, 1
  store i32 %inc, ptr %i, align 4, !tbaa !20
  br label %for.cond, !llvm.loop !59

for.end:                                          ; preds = %for.cond
  %88 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %89 = load ptr, ptr %rd, align 8, !tbaa !8
  %responseExtensions = getelementptr inbounds %struct.ocsp_response_data_st, ptr %89, i32 0, i32 4
  %90 = load ptr, ptr %responseExtensions, align 8, !tbaa !60
  %91 = load i64, ptr %flags.addr, align 8, !tbaa !4
  %call137 = call i32 @X509V3_extensions_print(ptr noundef %88, ptr noundef @.str.38, ptr noundef %90, i64 noundef %91, i32 noundef 4)
...
for.cond146:                                      ; preds = %for.inc160, %if.end145
  %96 = load i32, ptr %i, align 4, !tbaa !20
  %97 = load ptr, ptr %br, align 8, !tbaa !8
  %certs = getelementptr inbounds %struct.ocsp_basic_response_st, ptr %97, i32 0, i32 3
  %98 = load ptr, ptr %certs, align 8, !tbaa !63
...
for.body151:                                      ; preds = %for.cond146
  %99 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %100 = load ptr, ptr %br, align 8, !tbaa !8
  %certs152 = getelementptr inbounds %struct.ocsp_basic_response_st, ptr %100, i32 0, i32 3
  %101 = load ptr, ptr %certs152, align 8, !tbaa !63
  %call153 = call ptr @ossl_check_const_X509_sk_type(ptr noundef %101)
  %102 = load i32, ptr %i, align 4, !tbaa !20
  ...
  %103 = load ptr, ptr %bp.addr, align 8, !tbaa !8
  %104 = load ptr, ptr %br, align 8, !tbaa !8
  %certs156 = getelementptr inbounds %struct.ocsp_basic_response_st, ptr %104, i32 0, i32 3
  %105 = load ptr, ptr %certs156, align 8, !tbaa !63
  %call157 = call ptr @ossl_check_const_X509_sk_type(ptr noundef %105)
  %106 = load i32, ptr %i, align 4, !tbaa !20
...
for.inc160:                                       ; preds = %for.body151
  %107 = load i32, ptr %i, align 4, !tbaa !20
  %inc161 = add nsw i32 %107, 1
  store i32 %inc161, ptr %i, align 4, !tbaa !20
  br label %for.cond146, !llvm.loop !64

for.end162:                                       ; preds = %for.cond146
  store i32 1, ptr %ret, align 4, !tbaa !20
  br label %err
...
err:                                              ; preds = %for.end162, %if.then144, %if.then139, %if.then135, %if.then130, %if.then126, %if.then120, %if.then115, %if.then108, %if.then104, %if.then97, %if.then87, %if.then83, %if.then73, %if.then66, %if.then50, %if.then46, %if.then43, %if.then35, %if.then31, %if.then26, %if.then16, %if.then12, %if.then5, %if.then
  %108 = load ptr, ptr %br, align 8, !tbaa !8
  call void @OCSP_BASICRESP_free(ptr noundef %108)
  %109 = load i32, ptr %ret, align 4, !tbaa !20
  store i32 %109, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %err, %if.then21, %if.then8
  call void @llvm.lifetime.end.p0(i64 8, ptr %rb) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %single) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %rev) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %cst) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %rd) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %rid) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %br) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %cid) #4
  call void @llvm.lifetime.end.p0(i64 8, ptr %l) #4
...
!15 = !{!16, !9, i64 32}
!16 = !{!"ocsp_request_st", !17, i64 0, !9, i64 32}
!17 = !{!"ocsp_req_info_st", !9, i64 0, !9, i64 8, !9, i64 16, !9, i64 24}
!18 = !{!17, !9, i64 0}
!19 = !{!17, !9, i64 8}
!20 = !{!21, !21, i64 0}
!21 = !{!"int", !6, i64 0}
!22 = !{!17, !9, i64 16}
!23 = !{!24, !9, i64 0}
!24 = !{!"ocsp_one_request_st", !9, i64 0, !9, i64 8}
!25 = !{!24, !9, i64 8}
!26 = distinct !{!26, !14}
!27 = !{!17, !9, i64 24}
!28 = !{!29, !9, i64 16}
!29 = !{!"ocsp_signature_st", !30, i64 0, !9, i64 16, !9, i64 24}
!30 = !{!"X509_algor_st", !9, i64 0, !9, i64 8}
!31 = !{!29, !9, i64 24}
!32 = distinct !{!32, !14}
!33 = !{!34, !9, i64 0}
!34 = !{!"ocsp_cert_id_st", !30, i64 0, !35, i64 16, !35, i64 40, !35, i64 64}
!35 = !{!"asn1_string_st", !21, i64 0, !21, i64 4, !9, i64 8, !5, i64 16}
!36 = !{!37, !9, i64 8}
!37 = !{!"ocsp_response_st", !9, i64 0, !9, i64 8}
!38 = !{!37, !9, i64 0}
!39 = !{!40, !9, i64 0}
!40 = !{!"ocsp_resp_bytes_st", !9, i64 0, !9, i64 8}
!41 = !{!42, !9, i64 0}
!42 = !{!"ocsp_response_data_st", !9, i64 0, !43, i64 8, !9, i64 24, !9, i64 32, !9, i64 40}
!43 = !{!"ocsp_responder_id_st", !21, i64 0, !6, i64 8}
!44 = !{!43, !21, i64 0}
!45 = !{!6, !6, i64 0}
!46 = !{!42, !9, i64 24}
!47 = !{!42, !9, i64 32}
!48 = !{!49, !9, i64 0}
!49 = !{!"ocsp_single_response_st", !9, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !9, i64 32}
!50 = !{!49, !9, i64 8}
!51 = !{!52, !21, i64 0}
!52 = !{!"ocsp_cert_status_st", !21, i64 0, !6, i64 8}
!53 = !{!54, !9, i64 0}
!54 = !{!"ocsp_revoked_info_st", !9, i64 0, !9, i64 8}
!55 = !{!54, !9, i64 8}
!56 = !{!49, !9, i64 16}
!57 = !{!49, !9, i64 24}
!58 = !{!49, !9, i64 32}
...
!60 = !{!42, !9, i64 40}
!61 = !{!62, !9, i64 64}
!62 = !{!"ocsp_basic_response_st", !42, i64 0, !30, i64 48, !9, i64 64, !9, i64 72}
!63 = !{!62, !9, i64 72}
!64 = distinct !{!64, !14}
