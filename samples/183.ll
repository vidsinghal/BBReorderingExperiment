; ModuleID = 'samples/183.bc'
source_filename = "/local-ssd/xnnpack-r7msi2beibvbxa3e6lvblom7qlyd5i24-build/aidengro/spack-stage-xnnpack-2022-02-16-r7msi2beibvbxa3e6lvblom7qlyd5i24/spack-src/src/f32-vbinary/gen/vsub-relu-scalar-x4.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define hidden void @xnn_f32_vsub_relu_ukernel__scalar_x4(i64 noundef %n, ptr noundef %a, ptr noundef %b, ptr noundef %y, ptr noalias noundef align 1 dereferenceable(1) %params) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  store float %sub, ptr %vy0, align 4, !tbaa !11
  ...
  store float %sub9, ptr %vy1, align 4, !tbaa !11
  ...
  %sub10 = fsub float %23, %24
  store float %sub10, ptr %vy2, align 4, !tbaa !11
  ...
  store float %sub11, ptr %vy3, align 4, !tbaa !11
...
for.inc:                                          ; preds = %for.body
  ...
  %sub20 = sub i64 %40, 16
  store i64 %sub20, ptr %n.addr, align 8, !tbaa !5
...
do.body:                                          ; preds = %do.cond, %if.then
  ...
  %incdec.ptr23 = getelementptr inbounds float, ptr %44, i32 1
  store ptr %incdec.ptr23, ptr %b.addr, align 8, !tbaa !9
  ...
  store float %sub24, ptr %vy, align 4, !tbaa !11
  %48 = load float, ptr %vy, align 4, !tbaa !11
  %call25 = call float @math_max_f32(float noundef %48, float noundef 0.000000e+00)
  store float %call25, ptr %vy, align 4, !tbaa !11
  %49 = load float, ptr %vy, align 4, !tbaa !11
  %50 = load ptr, ptr %y.addr, align 8, !tbaa !9
  %incdec.ptr26 = getelementptr inbounds float, ptr %50, i32 1
  store ptr %incdec.ptr26, ptr %y.addr, align 8, !tbaa !9
  store float %49, ptr %50, align 4, !tbaa !11
  %51 = load i64, ptr %n.addr, align 8, !tbaa !5
  %sub27 = sub i64 %51, 4
  store i64 %sub27, ptr %n.addr, align 8, !tbaa !5
...
do.cond:                                          ; preds = %do.body
  ...
  %cmp28 = icmp ne i64 %52, 0
  br i1 %cmp28, label %do.body, label %do.end, !llvm.loop !15
