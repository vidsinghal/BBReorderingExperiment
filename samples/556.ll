...
entry:
  ...
  store ptr %pass, ptr %pass.addr, align 8, !tbaa !4
  store i32 %passlen, ptr %passlen.addr, align 4, !tbaa !8
  store ptr %salt, ptr %salt.addr, align 8, !tbaa !4
  store i32 %saltlen, ptr %saltlen.addr, align 4, !tbaa !8
  store i32 %iter, ptr %iter.addr, align 4, !tbaa !8
  store ptr %digest, ptr %digest.addr, align 8, !tbaa !4
  store i32 %keylen, ptr %keylen.addr, align 4, !tbaa !8
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %empty) #6
  store ptr @.str, ptr %empty, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 4, ptr %rv) #6
  store i32 1, ptr %rv, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %mode) #6
  store i32 1, ptr %mode, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 8, ptr %kdf) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %kctx) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %mdname) #6
  %0 = load ptr, ptr %digest.addr, align 8, !tbaa !4
  %call = call ptr @EVP_MD_get0_name(ptr noundef %0)
  store ptr %call, ptr %mdname, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 240, ptr %params) #6
  ...
  %1 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %cmp = icmp eq ptr %1, null
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %2 = load ptr, ptr %empty, align 8, !tbaa !4
  store ptr %2, ptr %pass.addr, align 8, !tbaa !4
  store i32 0, ptr %passlen.addr, align 4, !tbaa !8
  br label %if.end4

if.else:                                          ; preds = %entry
  %3 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  %cmp1 = icmp eq i32 %3, -1
  br i1 %cmp1, label %if.then2, label %if.end

if.then2:                                         ; preds = %if.else
  %4 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %call3 = call i64 @strlen(ptr noundef %4) #7
  %conv = trunc i64 %call3 to i32
  store i32 %conv, ptr %passlen.addr, align 4, !tbaa !8
  br label %if.end
...
if.end4:                                          ; preds = %if.end, %if.then
  %5 = load ptr, ptr %salt.addr, align 8, !tbaa !4
  %cmp5 = icmp eq ptr %5, null
  br i1 %cmp5, label %land.lhs.true, label %if.end10

land.lhs.true:                                    ; preds = %if.end4
  %6 = load i32, ptr %saltlen.addr, align 4, !tbaa !8
  %cmp7 = icmp eq i32 %6, 0
  br i1 %cmp7, label %if.then9, label %if.end10

if.then9:                                         ; preds = %land.lhs.true
  %7 = load ptr, ptr %empty, align 8, !tbaa !4
  store ptr %7, ptr %salt.addr, align 8, !tbaa !4
  br label %if.end10

if.end10:                                         ; preds = %if.then9, %land.lhs.true, %if.end4
  %8 = load ptr, ptr %libctx.addr, align 8, !tbaa !4
  %9 = load ptr, ptr %propq.addr, align 8, !tbaa !4
  %call11 = call ptr @EVP_KDF_fetch(ptr noundef %8, ptr noundef @.str.1, ptr noundef %9)
  store ptr %call11, ptr %kdf, align 8, !tbaa !4
  %10 = load ptr, ptr %kdf, align 8, !tbaa !4
...
if.end15:                                         ; preds = %if.end10
  %11 = load ptr, ptr %kdf, align 8, !tbaa !4
  %call16 = call ptr @EVP_KDF_CTX_new(ptr noundef %11)
  store ptr %call16, ptr %kctx, align 8, !tbaa !4
  %12 = load ptr, ptr %kdf, align 8, !tbaa !4
  call void @EVP_KDF_free(ptr noundef %12)
  %13 = load ptr, ptr %kctx, align 8, !tbaa !4
...
if.end20:                                         ; preds = %if.end15
  ...
  %15 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %16 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %14, ptr align 8 %tmp, i64 40, i1 false), !tbaa.struct !10
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp23) #6
  call void @OSSL_PARAM_construct_int(ptr sret(%struct.ossl_param_st) align 8 %tmp23, ptr noundef @.str.3, ptr noundef %mode)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %17, ptr align 8 %tmp23, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp23) #6
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp25) #6
  %19 = load ptr, ptr %salt.addr, align 8, !tbaa !4
  %20 = load i32, ptr %saltlen.addr, align 4, !tbaa !8
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %18, ptr align 8 %tmp25, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp25) #6
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp28) #6
  call void @OSSL_PARAM_construct_int(ptr sret(%struct.ossl_param_st) align 8 %tmp28, ptr noundef @.str.5, ptr noundef %iter.addr)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %21, ptr align 8 %tmp28, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp28) #6
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp30) #6
  %23 = load ptr, ptr %mdname, align 8, !tbaa !4
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %22, ptr align 8 %tmp30, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp30) #6
  %24 = load ptr, ptr %p, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 40, ptr %tmp31) #6
  call void @OSSL_PARAM_construct_end(ptr sret(%struct.ossl_param_st) align 8 %tmp31)
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %24, ptr align 8 %tmp31, i64 40, i1 false), !tbaa.struct !10
  call void @llvm.lifetime.end.p0(i64 40, ptr %tmp31) #6
  %25 = load ptr, ptr %kctx, align 8, !tbaa !4
  %26 = load ptr, ptr %out.addr, align 8, !tbaa !4
  %27 = load i32, ptr %keylen.addr, align 4, !tbaa !8
...
if.end38:                                         ; preds = %if.then37, %if.end20
  %28 = load ptr, ptr %kctx, align 8, !tbaa !4
  call void @EVP_KDF_CTX_free(ptr noundef %28)
  br label %do.body

do.body:                                          ; preds = %if.end38
  call void @llvm.lifetime.start.p0(i64 8, ptr %trc_out) #6
  store ptr null, ptr %trc_out, align 8, !tbaa !4
  call void @llvm.lifetime.end.p0(i64 8, ptr %trc_out) #6
  br label %do.cond
...
do.end:                                           ; preds = %do.cond
  %29 = load i32, ptr %rv, align 4, !tbaa !8
  store i32 %29, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %do.end, %if.then19, %if.then14
  call void @llvm.lifetime.end.p0(i64 8, ptr %p) #6
  call void @llvm.lifetime.end.p0(i64 240, ptr %params) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %mdname) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %kctx) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %kdf) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %mode) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %rv) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %empty) #6
...
entry:
  ...
  store i32 %keylen, ptr %keylen.addr, align 4, !tbaa !8
  store ptr %out, ptr %out.addr, align 8, !tbaa !4
  %0 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %1 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  %2 = load ptr, ptr %salt.addr, align 8, !tbaa !4
  %3 = load i32, ptr %saltlen.addr, align 4, !tbaa !8
  %4 = load i32, ptr %iter.addr, align 4, !tbaa !8
  %5 = load ptr, ptr %digest.addr, align 8, !tbaa !4
  %6 = load i32, ptr %keylen.addr, align 4, !tbaa !8
...
entry:
  ...
  store i32 %keylen, ptr %keylen.addr, align 4, !tbaa !8
  store ptr %out, ptr %out.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %digest) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %r) #6
  store i32 0, ptr %r, align 4, !tbaa !8
  %call = call ptr @EVP_MD_fetch(ptr noundef null, ptr noundef @.str.7, ptr noundef null)
  store ptr %call, ptr %digest, align 8, !tbaa !4
...
if.then:                                          ; preds = %entry
  ...
  %3 = load i32, ptr %saltlen.addr, align 4, !tbaa !8
  %4 = load i32, ptr %iter.addr, align 4, !tbaa !8
  %5 = load ptr, ptr %digest, align 8, !tbaa !4
  %6 = load i32, ptr %keylen.addr, align 4, !tbaa !8
  %7 = load ptr, ptr %out.addr, align 8, !tbaa !4
  ...
  store i32 %call1, ptr %r, align 4, !tbaa !8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %8 = load ptr, ptr %digest, align 8, !tbaa !4
  call void @EVP_MD_free(ptr noundef %8)
  %9 = load i32, ptr %r, align 4, !tbaa !8
  call void @llvm.lifetime.end.p0(i64 4, ptr %r) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %digest) #6
  ret i32 %9
}
...
entry:
  ...
  store i32 %en_de, ptr %en_de.addr, align 4, !tbaa !8
  store ptr %libctx, ptr %libctx.addr, align 8, !tbaa !4
  store ptr %propq, ptr %propq.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %pbe2) #6
  store ptr null, ptr %pbe2, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 80, ptr %ciph_name) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %cipher) #6
  store ptr null, ptr %cipher, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %cipher_fetch) #6
  store ptr null, ptr %cipher_fetch, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %kdf) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %rv) #6
  store i32 0, ptr %rv, align 4, !tbaa !8
  %call = call ptr @PBE2PARAM_it()
  %0 = load ptr, ptr %param.addr, align 8, !tbaa !4
  %call1 = call ptr @ASN1_TYPE_unpack_sequence(ptr noundef %call, ptr noundef %0)
  store ptr %call1, ptr %pbe2, align 8, !tbaa !4
  %1 = load ptr, ptr %pbe2, align 8, !tbaa !4
  %cmp = icmp eq ptr %1, null
  br i1 %cmp, label %if.then, label %if.end
...
if.end10:                                         ; preds = %if.end5
  ...
  store ptr %call13, ptr %cipher_fetch, align 8, !tbaa !4
  store ptr %call13, ptr %cipher, align 8, !tbaa !4
  %10 = load ptr, ptr %cipher, align 8, !tbaa !4
...
if.then15:                                        ; preds = %if.end10
  ...
  store ptr %call17, ptr %cipher, align 8, !tbaa !4
  br label %if.end18

if.end18:                                         ; preds = %if.then15, %if.end10
  %11 = load ptr, ptr %cipher, align 8, !tbaa !4
...
if.end22:                                         ; preds = %if.end18
  ...
  %13 = load ptr, ptr %cipher, align 8, !tbaa !4
  %14 = load i32, ptr %en_de.addr, align 4, !tbaa !8
...
if.end32:                                         ; preds = %if.end27
  %19 = load ptr, ptr %kdf, align 8, !tbaa !4
  %20 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %21 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %22 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  %23 = load ptr, ptr %pbe2, align 8, !tbaa !4
  %keyfunc33 = getelementptr inbounds %struct.PBE2PARAM_st, ptr %23, i32 0, i32 0
  %24 = load ptr, ptr %keyfunc33, align 8, !tbaa !13
  %parameter34 = getelementptr inbounds %struct.X509_algor_st, ptr %24, i32 0, i32 1
  %25 = load ptr, ptr %parameter34, align 8, !tbaa !18
  %26 = load i32, ptr %en_de.addr, align 4, !tbaa !8
  %27 = load ptr, ptr %libctx.addr, align 8, !tbaa !4
  %28 = load ptr, ptr %propq.addr, align 8, !tbaa !4
...
err:                                              ; preds = %if.end32, %if.then31, %if.then26, %if.then20, %if.then9, %if.then4, %if.then
  %29 = load ptr, ptr %cipher_fetch, align 8, !tbaa !4
  call void @EVP_CIPHER_free(ptr noundef %29)
  %30 = load ptr, ptr %pbe2, align 8, !tbaa !4
  call void @PBE2PARAM_free(ptr noundef %30)
  %31 = load i32, ptr %rv, align 4, !tbaa !8
  call void @llvm.lifetime.end.p0(i64 4, ptr %rv) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %kdf) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %cipher_fetch) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %cipher) #6
  call void @llvm.lifetime.end.p0(i64 80, ptr %ciph_name) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %pbe2) #6
  ret i32 %31
}
...
entry:
  ...
  %1 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %2 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  %3 = load ptr, ptr %param.addr, align 8, !tbaa !4
  %4 = load ptr, ptr %c.addr, align 8, !tbaa !4
  %5 = load ptr, ptr %md.addr, align 8, !tbaa !4
  %6 = load i32, ptr %en_de.addr, align 4, !tbaa !8
...
entry:
  ...
  store ptr %libctx, ptr %libctx.addr, align 8, !tbaa !4
  store ptr %propq, ptr %propq.addr, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %salt) #6
  call void @llvm.lifetime.start.p0(i64 64, ptr %key) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %saltlen) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %iter) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %t) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %rv) #6
  store i32 0, ptr %rv, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %keylen) #6
  store i32 0, ptr %keylen, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %prf_nid) #6
  call void @llvm.lifetime.start.p0(i64 4, ptr %hmac_md_nid) #6
  call void @llvm.lifetime.start.p0(i64 8, ptr %kdf) #6
  store ptr null, ptr %kdf, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %prfmd) #6
  store ptr null, ptr %prfmd, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %prfmd_fetch) #6
  store ptr null, ptr %prfmd_fetch, align 8, !tbaa !4
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  ...
  store i32 %call1, ptr %keylen, align 4, !tbaa !8
  %2 = load i32, ptr %keylen, align 4, !tbaa !8
...
cond.end:                                         ; preds = %3, %cond.true
  %cond = phi i32 [ 0, %cond.true ], [ 1, %3 ]
  %call4 = call ptr @PBKDF2PARAM_it()
  %4 = load ptr, ptr %param.addr, align 8, !tbaa !4
  %call5 = call ptr @ASN1_TYPE_unpack_sequence(ptr noundef %call4, ptr noundef %4)
  store ptr %call5, ptr %kdf, align 8, !tbaa !4
  %5 = load ptr, ptr %kdf, align 8, !tbaa !4
...
if.end9:                                          ; preds = %cond.end
  ...
  store i32 %call10, ptr %t, align 4, !tbaa !8
  %7 = load i32, ptr %t, align 4, !tbaa !8
...
if.end14:                                         ; preds = %if.end9
  %8 = load i32, ptr %t, align 4, !tbaa !8
  store i32 %8, ptr %keylen, align 4, !tbaa !8
  %9 = load ptr, ptr %kdf, align 8, !tbaa !4
  %keylength = getelementptr inbounds %struct.PBKDF2PARAM_st, ptr %9, i32 0, i32 2
  %10 = load ptr, ptr %keylength, align 8, !tbaa !19
...
land.lhs.true:                                    ; preds = %if.end14
  ...
  %12 = load ptr, ptr %keylength15, align 8, !tbaa !19
  %call16 = call i64 @ASN1_INTEGER_get(ptr noundef %12)
  %13 = load i32, ptr %keylen, align 4, !tbaa !8
...
if.end30:                                         ; preds = %if.end26
  ...
  %20 = load ptr, ptr %libctx.addr, align 8, !tbaa !4
  %21 = load i32, ptr %hmac_md_nid, align 4, !tbaa !8
  %call32 = call ptr @OBJ_nid2sn(i32 noundef %21)
  %22 = load ptr, ptr %propq.addr, align 8, !tbaa !4
  %call33 = call ptr @EVP_MD_fetch(ptr noundef %20, ptr noundef %call32, ptr noundef %22)
  store ptr %call33, ptr %prfmd_fetch, align 8, !tbaa !4
  store ptr %call33, ptr %prfmd, align 8, !tbaa !4
  %23 = load ptr, ptr %prfmd, align 8, !tbaa !4
  %cmp34 = icmp eq ptr %23, null
  br i1 %cmp34, label %if.then36, label %if.end39

if.then36:                                        ; preds = %if.end30
  %24 = load i32, ptr %hmac_md_nid, align 4, !tbaa !8
  %call37 = call ptr @OBJ_nid2sn(i32 noundef %24)
  %call38 = call ptr @EVP_get_digestbyname(ptr noundef %call37)
  store ptr %call38, ptr %prfmd, align 8, !tbaa !4
  br label %if.end39

if.end39:                                         ; preds = %if.then36, %if.end30
  %25 = load ptr, ptr %prfmd, align 8, !tbaa !4
...
if.end50:                                         ; preds = %if.end44
  %29 = load ptr, ptr %kdf, align 8, !tbaa !4
  %salt51 = getelementptr inbounds %struct.PBKDF2PARAM_st, ptr %29, i32 0, i32 0
  %30 = load ptr, ptr %salt51, align 8, !tbaa !22
  %value = getelementptr inbounds %struct.asn1_type_st, ptr %30, i32 0, i32 1
  %31 = load ptr, ptr %value, align 8, !tbaa !25
  %data = getelementptr inbounds %struct.asn1_string_st, ptr %31, i32 0, i32 2
  %32 = load ptr, ptr %data, align 8, !tbaa !26
  store ptr %32, ptr %salt, align 8, !tbaa !4
  %33 = load ptr, ptr %kdf, align 8, !tbaa !4
  %salt52 = getelementptr inbounds %struct.PBKDF2PARAM_st, ptr %33, i32 0, i32 0
  %34 = load ptr, ptr %salt52, align 8, !tbaa !22
  %value53 = getelementptr inbounds %struct.asn1_type_st, ptr %34, i32 0, i32 1
  %35 = load ptr, ptr %value53, align 8, !tbaa !25
  %length = getelementptr inbounds %struct.asn1_string_st, ptr %35, i32 0, i32 0
  %36 = load i32, ptr %length, align 8, !tbaa !28
  store i32 %36, ptr %saltlen, align 4, !tbaa !8
  %37 = load ptr, ptr %kdf, align 8, !tbaa !4
  %iter54 = getelementptr inbounds %struct.PBKDF2PARAM_st, ptr %37, i32 0, i32 1
  %38 = load ptr, ptr %iter54, align 8, !tbaa !29
  %call55 = call i64 @ASN1_INTEGER_get(ptr noundef %38)
  %conv56 = trunc i64 %call55 to i32
  store i32 %conv56, ptr %iter, align 4, !tbaa !8
  %39 = load ptr, ptr %pass.addr, align 8, !tbaa !4
  %40 = load i32, ptr %passlen.addr, align 4, !tbaa !8
  %41 = load ptr, ptr %salt, align 8, !tbaa !4
  %42 = load i32, ptr %saltlen, align 4, !tbaa !8
  %43 = load i32, ptr %iter, align 4, !tbaa !8
  %44 = load ptr, ptr %prfmd, align 8, !tbaa !4
  %45 = load i32, ptr %keylen, align 4, !tbaa !8
  %arraydecay = getelementptr inbounds [64 x i8], ptr %key, i64 0, i64 0
  %46 = load ptr, ptr %libctx.addr, align 8, !tbaa !4
  %47 = load ptr, ptr %propq.addr, align 8, !tbaa !4
...
if.end60:                                         ; preds = %if.end50
  ...
  %49 = load i32, ptr %en_de.addr, align 4, !tbaa !8
  ...
  store i32 %call62, ptr %rv, align 4, !tbaa !8
  br label %err
...
err:                                              ; preds = %if.end60, %if.then59, %if.then49, %if.then42, %if.then29, %if.then20, %if.then13, %if.then8, %if.then
  ...
  %50 = load i32, ptr %keylen, align 4, !tbaa !8
  %conv64 = zext i32 %50 to i64
  call void @OPENSSL_cleanse(ptr noundef %arraydecay63, i64 noundef %conv64)
  %51 = load ptr, ptr %kdf, align 8, !tbaa !4
  call void @PBKDF2PARAM_free(ptr noundef %51)
  %52 = load ptr, ptr %prfmd_fetch, align 8, !tbaa !4
  call void @EVP_MD_free(ptr noundef %52)
  %53 = load i32, ptr %rv, align 4, !tbaa !8
  call void @llvm.lifetime.end.p0(i64 8, ptr %prfmd_fetch) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %prfmd) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %kdf) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %hmac_md_nid) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %prf_nid) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %keylen) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %rv) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %t) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %iter) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %saltlen) #6
  call void @llvm.lifetime.end.p0(i64 64, ptr %key) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %salt) #6
  ret i32 %53
}
...
!12 = !{!"long", !6, i64 0}
!13 = !{!14, !5, i64 0}
!14 = !{!"PBE2PARAM_st", !5, i64 0, !5, i64 8}
!15 = !{!16, !5, i64 0}
!16 = !{!"X509_algor_st", !5, i64 0, !5, i64 8}
!17 = !{!14, !5, i64 8}
!18 = !{!16, !5, i64 8}
!19 = !{!20, !5, i64 16}
!20 = !{!"PBKDF2PARAM_st", !5, i64 0, !5, i64 8, !5, i64 16, !5, i64 24}
!21 = !{!20, !5, i64 24}
!22 = !{!20, !5, i64 0}
!23 = !{!24, !9, i64 0}
!24 = !{!"asn1_type_st", !9, i64 0, !6, i64 8}
!25 = !{!6, !6, i64 0}
!26 = !{!27, !5, i64 8}
!27 = !{!"asn1_string_st", !9, i64 0, !9, i64 4, !5, i64 8, !12, i64 16}
!28 = !{!27, !9, i64 0}
!29 = !{!20, !5, i64 8}
