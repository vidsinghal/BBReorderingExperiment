; ModuleID = 'samples/896.bc'
source_filename = "/local-ssd/libflame-e5nfvhftngyb7czajtt6ztnesna24ye7-build/aidengro/spack-stage-libflame-5.2.0-e5nfvhftngyb7czajtt6ztnesna24ye7/spack-src/src/blas/3/trsm/llt/flamec/FLA_Trsm_llt_unb_var4.c"
...
define i32 @FLA_Trsm_llt_unb_var4(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call5 = call i32 @FLA_Trsv_external(i32 noundef 300, i32 noundef 401, i32 noundef %0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1)
