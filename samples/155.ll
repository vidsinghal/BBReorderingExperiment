; ModuleID = 'samples/155.bc'
source_filename = "/local-ssd/libflame-e5nfvhftngyb7czajtt6ztnesna24ye7-build/aidengro/spack-stage-libflame-5.2.0-e5nfvhftngyb7czajtt6ztnesna24ye7/spack-src/src/blas/3/trmm/llt/flamec/FLA_Trmm_llt_blk_var2.c"
...
define i32 @FLA_Trmm_llt_blk_var2(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef %cntl) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call8 = call i32 @FLA_Gemm_internal(i32 noundef 401, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A10, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B0, ptr noundef %8)
  ...
  %call9 = call i32 @FLA_Trmm_internal(i32 noundef 210, i32 noundef 300, i32 noundef 401, i32 noundef %9, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef %11)
