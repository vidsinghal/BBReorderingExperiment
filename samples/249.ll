; ModuleID = 'samples/249.bc'
source_filename = "/local-ssd/libflame-e5nfvhftngyb7czajtt6ztnesna24ye7-build/aidengro/spack-stage-libflame-5.2.0-e5nfvhftngyb7czajtt6ztnesna24ye7/spack-src/src/lapack/red/eig/gest/iu/flamec/FLA_Eig_gest_iu_unb_var2.c"
...
define i32 @FLA_Eig_gest_iu_unb_var2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %Y, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B) #0 {
entry:
  ...
  %y01_l = alloca %struct.FLA_Obj_view, align 8
  %y01_r = alloca %struct.FLA_Obj_view, align 8
  ...
  %call2 = call i32 @FLA_Part_2x1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %Y, ptr noundef %yT, ptr noundef %yB, i64 noundef 0, i32 noundef 200)
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %call7 = call i32 @FLA_Repart_2x1_to_3x1(ptr noundef byval(%struct.FLA_Obj_view) align 8 %yT, ptr noundef %y01, ptr noundef %psi11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %yB, ptr noundef %y21, i64 noundef 1, i32 noundef 201)
  %call8 = call i32 @FLA_Part_1x2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %y01, ptr noundef %y01_l, ptr noundef %y01_r, i64 noundef 1, i32 noundef 210)
  %call9 = call i32 @FLA_Hemvc_external(i32 noundef 301, i32 noundef 450, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE_HALF, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A00, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b01, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ZERO, ptr noundef byval(%struct.FLA_Obj_view) align 8 %y01_l)
  %call10 = call i32 @FLA_Axpy_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %y01_l, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a01)
  %call11 = call i32 @FLA_Dot2cs_external(i32 noundef 451, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a01, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b01, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha11)
  %call12 = call i32 @FLA_Inv_scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha11)
  %call13 = call i32 @FLA_Inv_scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha11)
  %call14 = call i32 @FLA_Gemvc_external(i32 noundef 401, i32 noundef 451, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A02, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b01, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a12t)
  %call15 = call i32 @FLA_Inv_scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a12t)
  %call16 = call i32 @FLA_Axpy_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %y01_l, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a01)
  %call17 = call i32 @FLA_Inv_scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %a01)
  ...
  %call20 = call i32 @FLA_Cont_with_3x1_to_2x1(ptr noundef %yT, ptr noundef byval(%struct.FLA_Obj_view) align 8 %y01, ptr noundef byval(%struct.FLA_Obj_view) align 8 %psi11, ptr noundef %yB, ptr noundef byval(%struct.FLA_Obj_view) align 8 %y21, i32 noundef 200)
...
declare i32 @FLA_Inv_scal_external(ptr noundef byval(%struct.FLA_Obj_view) align 8, ptr noundef byval(%struct.FLA_Obj_view) align 8) #1
