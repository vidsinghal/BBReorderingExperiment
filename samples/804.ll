; ModuleID = 'samples/804.bc'
source_filename = "/local-ssd/libflame-e5nfvhftngyb7czajtt6ztnesna24ye7-build/aidengro/spack-stage-libflame-5.2.0-e5nfvhftngyb7czajtt6ztnesna24ye7/spack-src/src/lapack/dec/lu/nopiv/front/flamec/FLASH_LU_nopiv.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.FLA_Obj_view = type { i64, i64, i64, i64, i64, i64, ptr }

@flash_lu_nopiv_cntl = external global ptr, align 8

; Function Attrs: noinline nounwind optnone uwtable
define i32 @FLASH_LU_nopiv(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A) #0 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %0 = load ptr, ptr @flash_lu_nopiv_cntl, align 8
...
if.then5:                                         ; preds = %if.end
  %call6 = call i32 @FLASH_LU_find_zero_on_diagonal(ptr noundef byval(%struct.FLA_Obj_view) align 8 %A)
...
declare i32 @FLASH_LU_find_zero_on_diagonal(ptr noundef byval(%struct.FLA_Obj_view) align 8) #1
