; ModuleID = 'samples/910.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/blas/3/trmm/lut/flamec/FLA_Trmm_lut_unb_var3.c"
...
define i32 @FLA_Trmm_lut_unb_var3(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call5 = call i32 @FLA_Trmv_external(i32 noundef 301, i32 noundef 401, i32 noundef %0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %b1)
