; ModuleID = 'samples/255.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/map/lapack2flamec/f2c/c/cspcon.c"
...
@.str.2 = private unnamed_addr constant [7 x i8] c"CSPCON\00", align 1
@c__1 = internal global i32 1, align 4

; Function Attrs: nounwind uwtable
define i32 @cspcon_(ptr noundef %uplo, ptr noundef %n, ptr noundef %ap, ptr noundef %ipiv, ptr noundef %anorm, ptr noundef %rcond, ptr noundef %work, ptr noundef %info) #0 {
entry:
...
if.then68:                                        ; preds = %L30
  ...
  %call72 = call i32 @csptrs_(ptr noundef %70, ptr noundef %71, ptr noundef @c__1, ptr noundef %arrayidx69, ptr noundef %arrayidx70, ptr noundef %arrayidx71, ptr noundef %75, ptr noundef %76)
  br label %L30
...
declare i32 @csptrs_(ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) #2
