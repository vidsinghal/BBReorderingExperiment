...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1280, ptr %buf) #6
  call void @llvm.lifetime.start.p0(i64 144, ptr %sb) #6
...
if.end:                                           ; preds = %entry
  ...
  store ptr %call, ptr %in, align 8, !tbaa !4
...
if.then2:                                         ; preds = %if.end
  ...
  %2 = load ptr, ptr %file.addr, align 8, !tbaa !4
...
if.end3:                                          ; preds = %if.end
  %3 = load ptr, ptr %in, align 8, !tbaa !4
  %call4 = call i32 @fileno(ptr noundef %3) #6
  %call5 = call i32 @fstat(i32 noundef %call4, ptr noundef %sb) #6
...
if.then7:                                         ; preds = %if.end3
  ...
  %5 = load ptr, ptr %in, align 8, !tbaa !4
...
if.then11:                                        ; preds = %if.end9
  ...
  %7 = load i32, ptr %st_mode, align 8, !tbaa !12
  %and = and i32 %7, 61440
...
if.then13:                                        ; preds = %if.then11
  ...
  %8 = load i64, ptr %st_size, align 8, !tbaa !15
  store i64 %8, ptr %bytes.addr, align 8, !tbaa !8
  br label %if.end14

if.else:                                          ; preds = %if.then11
  store i64 256, ptr %bytes.addr, align 8, !tbaa !8
  br label %if.end14
...
if.end15:                                         ; preds = %if.end14, %if.end9
  %9 = load ptr, ptr %in, align 8, !tbaa !4
  call void @setbuf(ptr noundef %9, ptr noundef null) #6
  br label %for.cond
...
if.then17:                                        ; preds = %for.cond
  %11 = load i64, ptr %bytes.addr, align 8, !tbaa !8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 %cond, ptr %n, align 4, !tbaa !10
  br label %if.end20

if.else19:                                        ; preds = %for.cond
  store i32 1280, ptr %n, align 4, !tbaa !10
  br label %if.end20
...
if.end37:                                         ; preds = %if.end33
  ...
  %23 = load i32, ptr %ret, align 4, !tbaa !10
  %add = add nsw i32 %23, %22
  store i32 %add, ptr %ret, align 4, !tbaa !10
...
land.lhs.true42:                                  ; preds = %if.end37
  ...
  %26 = load i64, ptr %bytes.addr, align 8, !tbaa !8
  %sub = sub nsw i64 %26, %conv43
  store i64 %sub, ptr %bytes.addr, align 8, !tbaa !8
...
for.end:                                          ; preds = %if.then46, %if.then36
  ...
  %27 = load ptr, ptr %in, align 8, !tbaa !4
...
if.then52:                                        ; preds = %for.end
  ...
  %28 = load ptr, ptr %file.addr, align 8, !tbaa !4
...
if.end53:                                         ; preds = %for.end
  %29 = load i32, ptr %ret, align 4, !tbaa !10
  store i32 %29, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end53, %if.then52, %if.then7, %if.then2, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 144, ptr %sb) #6
  call void @llvm.lifetime.end.p0(i64 1280, ptr %buf) #6
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #6
  store i32 -1, ptr %ret, align 4, !tbaa !10
  call void @llvm.lifetime.start.p0(i64 8, ptr %out) #6
  store ptr null, ptr %out, align 8, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 144, ptr %sb) #6
  %0 = load ptr, ptr %file.addr, align 8, !tbaa !4
  %call = call i32 @stat(ptr noundef %0, ptr noundef %sb) #6
...
if.end5:                                          ; preds = %if.end
  ...
  %3 = load ptr, ptr %file.addr, align 8, !tbaa !4
  %call6 = call i32 (ptr, i32, ...) @open(ptr noundef %3, i32 noundef 65, i32 noundef 384)
  store i32 %call6, ptr %fd, align 4, !tbaa !10
  %4 = load i32, ptr %fd, align 4, !tbaa !10
  %cmp7 = icmp ne i32 %4, -1
  br i1 %cmp7, label %if.then8, label %if.end10

if.then8:                                         ; preds = %if.end5
  %5 = load i32, ptr %fd, align 4, !tbaa !10
  %call9 = call noalias ptr @fdopen(i32 noundef %5, ptr noundef @.str.3) #6
  store ptr %call9, ptr %out, align 8, !tbaa !4
  br label %if.end10

if.end10:                                         ; preds = %if.then8, %if.end5
  call void @llvm.lifetime.end.p0(i64 4, ptr %fd) #6
  %6 = load ptr, ptr %out, align 8, !tbaa !4
  %cmp11 = icmp eq ptr %6, null
  br i1 %cmp11, label %if.then12, label %if.end14

if.then12:                                        ; preds = %if.end10
  %7 = load ptr, ptr %file.addr, align 8, !tbaa !4
  %call13 = call ptr @openssl_fopen(ptr noundef %7, ptr noundef @.str.3)
  store ptr %call13, ptr %out, align 8, !tbaa !4
  br label %if.end14

if.end14:                                         ; preds = %if.then12, %if.end10
  %8 = load ptr, ptr %out, align 8, !tbaa !4
...
if.then16:                                        ; preds = %if.end14
  ...
  %9 = load ptr, ptr %file.addr, align 8, !tbaa !4
...
if.end17:                                         ; preds = %if.end14
  %10 = load ptr, ptr %file.addr, align 8, !tbaa !4
  %call18 = call i32 @chmod(ptr noundef %10, i32 noundef 384) #6
  %arraydecay19 = getelementptr inbounds [1024 x i8], ptr %buf, i64 0, i64 0
  %11 = load ptr, ptr %out, align 8, !tbaa !4
  ...
  store i32 %conv, ptr %ret, align 4, !tbaa !10
  %12 = load ptr, ptr %out, align 8, !tbaa !4
  ...
  %13 = load i32, ptr %ret, align 4, !tbaa !10
  store i32 %13, ptr %retval, align 4
  store i32 1, ptr %cleanup.dest.slot, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end17, %if.then16, %if.then4, %if.then
  call void @llvm.lifetime.end.p0(i64 144, ptr %sb) #6
  call void @llvm.lifetime.end.p0(i64 8, ptr %out) #6
  call void @llvm.lifetime.end.p0(i64 4, ptr %ret) #6
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %use_randfile) #6
  store i32 1, ptr %use_randfile, align 4, !tbaa !10
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 0, ptr %use_randfile, align 4, !tbaa !10
...
if.end11:                                         ; preds = %lor.lhs.false6
  ...
  %call12 = call i64 @strlen(ptr noundef %5) #8
  store i64 %call12, ptr %len, align 8, !tbaa !8
  %6 = load i32, ptr %use_randfile, align 4, !tbaa !10
  %tobool = icmp ne i32 %6, 0
  br i1 %tobool, label %if.then13, label %if.else

if.then13:                                        ; preds = %if.end11
  %7 = load i64, ptr %len, align 8, !tbaa !8
  %add = add i64 %7, 1
  %8 = load i64, ptr %size.addr, align 8, !tbaa !8
...
if.end17:                                         ; preds = %if.then13
  ...
  %call18 = call ptr @strcpy(ptr noundef %9, ptr noundef %10) #6
  br label %if.end29

if.else:                                          ; preds = %if.end11
  %11 = load i64, ptr %len, align 8, !tbaa !8
  %add19 = add i64 %11, 1
  %add20 = add i64 %add19, 4
  %add21 = add i64 %add20, 1
  %12 = load i64, ptr %size.addr, align 8, !tbaa !8
...
if.end25:                                         ; preds = %if.else
  ...
  %call26 = call ptr @strcpy(ptr noundef %13, ptr noundef %14) #6
  %15 = load ptr, ptr %buf.addr, align 8, !tbaa !4
  %call27 = call ptr @strcat(ptr noundef %15, ptr noundef @.str.6) #6
  %16 = load ptr, ptr %buf.addr, align 8, !tbaa !4
  %call28 = call ptr @strcat(ptr noundef %16, ptr noundef @.str.7) #6
  br label %if.end29
...
cleanup:                                          ; preds = %if.end29, %if.then24, %if.then16, %if.then10
  call void @llvm.lifetime.end.p0(i64 4, ptr %use_randfile) #6
...
!11 = !{!"int", !6, i64 0}
!12 = !{!13, !11, i64 24}
!13 = !{!"stat", !9, i64 0, !9, i64 8, !9, i64 16, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !9, i64 40, !9, i64 48, !9, i64 56, !9, i64 64, !14, i64 72, !14, i64 88, !14, i64 104, !6, i64 120}
