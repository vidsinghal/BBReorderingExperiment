; ModuleID = 'samples/299.bc'
source_filename = "/local-ssd/xnnpack-r7msi2beibvbxa3e6lvblom7qlyd5i24-build/aidengro/spack-stage-xnnpack-2022-02-16-r7msi2beibvbxa3e6lvblom7qlyd5i24/spack-src/src/math/sigmoid-f32-avx512f-rr1-lut16-p3-perm-scalef-nr1fma.c"
...
define dso_local void @xnn_math_f32_sigmoid__avx512f_rr1_lut16_p3_perm_scalef_nr1fma(i64 noundef %n, ptr noundef %input, ptr noundef %output) #0 {
entry:
  ...
  %vtable = alloca <16 x float>, align 64
  ...
  %call1 = call <16 x float> @_mm512_set1_ps(float noundef 7.864320e+05)
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr %vtable) #5
  %call3 = call <16 x float> @_mm512_set_ps(float noundef 0x3FFEA4AFA0000000, float noundef 0x3FFD5818E0000000, float noundef 0x3FFC199BE0000000, float noundef 0x3FFAE89FA0000000, float noundef 0x3FF9C49180000000, float noundef 0x3FF8ACE540000000, float noundef 0x3FF7A11480000000, float noundef 0x3FF6A09E60000000, float noundef 0x3FF5AB07E0000000, float noundef 0x3FF4BFDAE0000000, float noundef 0x3FF3DEA640000000, float noundef 0x3FF306FE00000000, float noundef 0x3FF2387A60000000, float noundef 0x3FF172B840000000, float noundef 0x3FF0B55860000000, float noundef 1.000000e+00)
  store <16 x float> %call3, ptr %vtable, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vminus_ln2) #5
  %call4 = call <16 x float> @_mm512_set1_ps(float noundef 0xBFE62E4300000000)
  store <16 x float> %call4, ptr %vminus_ln2, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vc3) #5
  %call5 = call <16 x float> @_mm512_set1_ps(float noundef 0x3FC55559A0000000)
  store <16 x float> %call5, ptr %vc3, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vc2) #5
  %call6 = call <16 x float> @_mm512_set1_ps(float noundef 0x3FE00021E0000000)
  store <16 x float> %call6, ptr %vc2, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vone) #5
  %call7 = call <16 x float> @_mm512_set1_ps(float noundef 1.000000e+00)
  store <16 x float> %call7, ptr %vone, align 64, !tbaa !11
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call8 = call <16 x float> @_mm512_loadu_ps(ptr noundef %1)
  store <16 x float> %call8, ptr %vx, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vz) #5
  %2 = load <16 x float>, ptr %vx, align 64, !tbaa !11
  %call9 = call <8 x i64> @_mm512_castps_si512(<16 x float> noundef %2)
  %3 = load <8 x i64>, ptr %vsign_mask, align 64, !tbaa !11
  %call10 = call <8 x i64> @_mm512_or_epi32(<8 x i64> noundef %call9, <8 x i64> noundef %3)
  %call11 = call <16 x float> @_mm512_castsi512_ps(<8 x i64> noundef %call10)
  store <16 x float> %call11, ptr %vz, align 64, !tbaa !11
  ...
  %call12 = call <16 x float> @_mm512_fmadd_ps(<16 x float> noundef %4, <16 x float> noundef %5, <16 x float> noundef %6)
  store <16 x float> %call12, ptr %vn, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vl) #5
  %7 = load <16 x float>, ptr %vn, align 64, !tbaa !11
  %call13 = call <8 x i64> @_mm512_castps_si512(<16 x float> noundef %7)
  %8 = load <16 x float>, ptr %vtable, align 64, !tbaa !11
  %call14 = call <16 x float> @_mm512_permutexvar_ps(<8 x i64> noundef %call13, <16 x float> noundef %8)
  store <16 x float> %call14, ptr %vl, align 64, !tbaa !11
  %9 = load <16 x float>, ptr %vn, align 64, !tbaa !11
  %10 = load <16 x float>, ptr %vmagic_bias, align 64, !tbaa !11
  %call15 = call <16 x float> @_mm512_sub_ps(<16 x float> noundef %9, <16 x float> noundef %10)
  store <16 x float> %call15, ptr %vn, align 64, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 64, ptr %vt) #5
  %11 = load <16 x float>, ptr %vn, align 64, !tbaa !11
  %12 = load <16 x float>, ptr %vminus_ln2, align 64, !tbaa !11
  %13 = load <16 x float>, ptr %vz, align 64, !tbaa !11
  %call16 = call <16 x float> @_mm512_fmadd_ps(<16 x float> noundef %11, <16 x float> noundef %12, <16 x float> noundef %13)
  store <16 x float> %call16, ptr %vt, align 64, !tbaa !11
  ...
  %16 = load <16 x float>, ptr %vc2, align 64, !tbaa !11
  %call17 = call <16 x float> @_mm512_fmadd_ps(<16 x float> noundef %14, <16 x float> noundef %15, <16 x float> noundef %16)
  store <16 x float> %call17, ptr %vp, align 64, !tbaa !11
  %17 = load <16 x float>, ptr %vp, align 64, !tbaa !11
  %18 = load <16 x float>, ptr %vt, align 64, !tbaa !11
  %call18 = call <16 x float> @_mm512_mul_ps(<16 x float> noundef %17, <16 x float> noundef %18)
  store <16 x float> %call18, ptr %vp, align 64, !tbaa !11
  %19 = load <16 x float>, ptr %vt, align 64, !tbaa !11
  %20 = load <16 x float>, ptr %vp, align 64, !tbaa !11
  ...
  %23 = load <16 x float>, ptr %vp, align 64, !tbaa !11
  %24 = load <16 x float>, ptr %vl, align 64, !tbaa !11
  ...
  %38 = load <16 x float>, ptr %vx, align 64, !tbaa !11
  %call27 = call <8 x i64> @_mm512_castps_si512(<16 x float> noundef %38)
  %39 = load <8 x i64>, ptr %vsign_mask, align 64, !tbaa !11
  %call28 = call zeroext i16 @_mm512_testn_epi32_mask(<8 x i64> noundef %call27, <8 x i64> noundef %39)
  %40 = load <16 x float>, ptr %vone, align 64, !tbaa !11
  %41 = load <16 x float>, ptr %vf, align 64, !tbaa !11
  %call29 = call <16 x float> @_mm512_mask_sub_ps(<16 x float> noundef %37, i16 noundef zeroext %call28, <16 x float> noundef %40, <16 x float> noundef %41)
  store <16 x float> %call29, ptr %vf, align 64, !tbaa !11
  %42 = load ptr, ptr %output.addr, align 8, !tbaa !9
  %43 = load <16 x float>, ptr %vf, align 64, !tbaa !11
  call void @_mm512_storeu_ps(ptr noundef %42, <16 x float> noundef %43)
  %44 = load ptr, ptr %input.addr, align 8, !tbaa !9
  %add.ptr = getelementptr inbounds float, ptr %44, i64 16
  store ptr %add.ptr, ptr %input.addr, align 8, !tbaa !9
  %45 = load ptr, ptr %output.addr, align 8, !tbaa !9
  %add.ptr30 = getelementptr inbounds float, ptr %45, i64 16
  store ptr %add.ptr30, ptr %output.addr, align 8, !tbaa !9
...
for.inc:                                          ; preds = %for.body
  %46 = load i64, ptr %n.addr, align 8, !tbaa !5
  %sub = sub i64 %46, 64
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr %vtable) #5
...
; Function Attrs: alwaysinline nounwind uwtable
define internal <16 x float> @_mm512_permutexvar_ps(<8 x i64> noundef %__X, <16 x float> noundef %__Y) #2 {
entry:
  %__X.addr = alloca <8 x i64>, align 64
  %__Y.addr = alloca <16 x float>, align 64
  store <8 x i64> %__X, ptr %__X.addr, align 64, !tbaa !11
  store <16 x float> %__Y, ptr %__Y.addr, align 64, !tbaa !11
  %0 = load <16 x float>, ptr %__Y.addr, align 64, !tbaa !11
  %1 = load <8 x i64>, ptr %__X.addr, align 64, !tbaa !11
  %2 = bitcast <8 x i64> %1 to <16 x i32>
  %3 = call <16 x float> @llvm.x86.avx512.permvar.sf.512(<16 x float> %0, <16 x i32> %2)
  ret <16 x float> %3
}
...
; Function Attrs: nocallback nofree nosync nounwind willreturn memory(none)
declare <16 x float> @llvm.x86.avx512.rcp14.ps.512(<16 x float>, <16 x float>, i16) #4
