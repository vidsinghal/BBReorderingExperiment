; ModuleID = 'samples/642.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/blas/3/hemm/rl/flamec/FLA_Hemm_rl_blk_var8.c"
...
define i32 @FLA_Hemm_rl_blk_var8(ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef byval(%struct.FLA_Obj_view) align 8 %beta, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C, ptr noundef %cntl) #0 {
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 56, ptr %CL) #3
  call void @llvm.lifetime.start.p0(i64 56, ptr %CR) #3
  ...
  %call3 = call i32 @FLA_Part_1x2(ptr noundef byval(%struct.FLA_Obj_view) align 8 %C, ptr noundef %CL, ptr noundef %CR, i64 noundef 0, i32 noundef 211)
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %call8 = call i32 @FLA_Repart_1x2_to_1x3(ptr noundef byval(%struct.FLA_Obj_view) align 8 %BL, ptr noundef byval(%struct.FLA_Obj_view) align 8 %BR, ptr noundef %B0, ptr noundef %B1, ptr noundef %B2, i64 noundef %6, i32 noundef 210)
  %7 = load i64, ptr %b, align 8, !tbaa !12
  %call9 = call i32 @FLA_Repart_1x2_to_1x3(ptr noundef byval(%struct.FLA_Obj_view) align 8 %CL, ptr noundef byval(%struct.FLA_Obj_view) align 8 %CR, ptr noundef %C0, ptr noundef %C1, ptr noundef %C2, i64 noundef %7, i32 noundef 210)
  ...
  %call10 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A10, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C0, ptr noundef %9)
  ...
  %call11 = call i32 @FLA_Hemm_internal(i32 noundef 211, i32 noundef 300, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C1, ptr noundef %11)
  ...
  %call12 = call i32 @FLA_Gemm_internal(i32 noundef 400, i32 noundef 402, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A21, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C2, ptr noundef %13)
  ...
  %call15 = call i32 @FLA_Cont_with_1x3_to_1x2(ptr noundef %CL, ptr noundef %CR, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C0, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C1, ptr noundef byval(%struct.FLA_Obj_view) align 8 %C2, i32 noundef 211)
...
while.end:                                        ; preds = %while.cond
  ...
  call void @llvm.lifetime.end.p0(i64 56, ptr %CR) #3
  call void @llvm.lifetime.end.p0(i64 56, ptr %CL) #3
