; ModuleID = 'samples/907.bc'
source_filename = "/local-ssd/amdlibflame-otrkevhm552xspevawtkllysqp2goz3p-build/aidengro/spack-stage-amdlibflame-4.1-otrkevhm552xspevawtkllysqp2goz3p/spack-src/src/lapack/inv/tri/un/flamec/FLA_Trinv_un_opt_var1.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr %alpha11_m1) #3
...
for.body:                                         ; preds = %for.cond
  ...
  %13 = load i32, ptr %rs_A.addr, align 4, !tbaa !4
  %mul13 = mul nsw i32 %12, %13
  %idx.ext14 = sext i32 %mul13 to i64
  %add.ptr15 = getelementptr inbounds float, ptr %add.ptr12, i64 %idx.ext14
  store ptr %add.ptr15, ptr %alpha11, align 8, !tbaa !19
  call void @llvm.lifetime.start.p0(i64 4, ptr %mn_behind) #3
  %14 = load i32, ptr %i, align 4, !tbaa !4
  store i32 %14, ptr %mn_behind, align 4, !tbaa !4
  %15 = load i32, ptr %mn_behind, align 4, !tbaa !4
  %16 = load ptr, ptr %A00, align 8, !tbaa !19
  %17 = load i32, ptr %rs_A.addr, align 4, !tbaa !4
  %18 = load i32, ptr %cs_A.addr, align 4, !tbaa !4
  %19 = load ptr, ptr %a01, align 8, !tbaa !19
  ...
  %21 = load ptr, ptr %alpha11, align 8, !tbaa !19
  %22 = load float, ptr %21, align 4, !tbaa !20
  %mul16 = fmul float -1.000000e+00, %22
  store float %mul16, ptr %alpha11_m1, align 4, !tbaa !20
  %23 = load i32, ptr %mn_behind, align 4, !tbaa !4
  %24 = load ptr, ptr %a01, align 8, !tbaa !19
  %25 = load i32, ptr %rs_A.addr, align 4, !tbaa !4
  call void @bl1_sinvscalv(i32 noundef 500, i32 noundef %23, ptr noundef %alpha11_m1, ptr noundef %24, i32 noundef %25)
  %26 = load ptr, ptr %alpha11, align 8, !tbaa !19
...
for.inc:                                          ; preds = %for.body
  %27 = load i32, ptr %i, align 4, !tbaa !4
...
for.end:                                          ; preds = %for.cond
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %alpha11_m1) #3
  ret i32 -1
}
...
entry:
  ...
  store i32 %rs_A, ptr %rs_A.addr, align 4, !tbaa !4
  store i32 %cs_A, ptr %cs_A.addr, align 4, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 8, ptr %alpha11_m1) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #3
  store i32 0, ptr %i, align 4, !tbaa !4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store double %mul16, ptr %alpha11_m1, align 8, !tbaa !24
  %23 = load i32, ptr %mn_behind, align 4, !tbaa !4
  %24 = load ptr, ptr %a01, align 8, !tbaa !19
  %25 = load i32, ptr %rs_A.addr, align 4, !tbaa !4
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #3
  call void @llvm.lifetime.end.p0(i64 8, ptr %alpha11_m1) #3
  ret i32 -1
}
...
for.body:                                         ; preds = %for.cond
  ...
  %22 = load float, ptr %real, align 4, !tbaa !27
  %mul16 = fmul float -1.000000e+00, %22
  %real17 = getelementptr inbounds %struct.scomplex, ptr %alpha11_m1, i32 0, i32 0
  store float %mul16, ptr %real17, align 4, !tbaa !27
  %23 = load ptr, ptr %alpha11, align 8, !tbaa !19
  %imag = getelementptr inbounds %struct.scomplex, ptr %23, i32 0, i32 1
  %24 = load float, ptr %imag, align 4, !tbaa !29
  %mul18 = fmul float -1.000000e+00, %24
  %imag19 = getelementptr inbounds %struct.scomplex, ptr %alpha11_m1, i32 0, i32 1
  store float %mul18, ptr %imag19, align 4, !tbaa !29
  %25 = load i32, ptr %mn_behind, align 4, !tbaa !4
  %26 = load ptr, ptr %a01, align 8, !tbaa !19
  %27 = load i32, ptr %rs_A.addr, align 4, !tbaa !4
  call void @bl1_cinvscalv(i32 noundef 500, i32 noundef %25, ptr noundef %alpha11_m1, ptr noundef %26, i32 noundef %27)
  %28 = load ptr, ptr %alpha11, align 8, !tbaa !19
...
entry:
  ...
  store i32 %rs_A, ptr %rs_A.addr, align 4, !tbaa !4
  store i32 %cs_A, ptr %cs_A.addr, align 4, !tbaa !4
  call void @llvm.lifetime.start.p0(i64 16, ptr %alpha11_m1) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %i) #3
  store i32 0, ptr %i, align 4, !tbaa !4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  call void @llvm.lifetime.end.p0(i64 4, ptr %i) #3
  call void @llvm.lifetime.end.p0(i64 16, ptr %alpha11_m1) #3
  ret i32 -1
}
...
declare void @bl1_sinverts(i32 noundef, ptr noundef) #2
...
declare void @bl1_dinverts(i32 noundef, ptr noundef) #2
...
declare void @bl1_cinverts(i32 noundef, ptr noundef) #2
...
declare void @bl1_zinverts(i32 noundef, ptr noundef) #2
