...
entry:
  ...
  %call = call i32 @ossl_statem_in_error(ptr noundef %0)
...
if.end:                                           ; preds = %entry
  ...
  %call1 = call i32 @SSL_get_state(ptr noundef %1)
  switch i32 %call1, label %sw.default [
    ...
    i32 43, label %sw.bb40
    i32 44, label %sw.bb41
    i32 45, label %sw.bb42
    i32 46, label %sw.bb43
    i32 47, label %sw.bb44
    i32 48, label %sw.bb45
    i32 49, label %sw.bb46
  ]
...
return:                                           ; preds = %sw.default, %sw.bb46, %sw.bb45, %sw.bb44, %sw.bb43, %sw.bb42, %sw.bb41, %sw.bb40, %sw.bb39, %sw.bb38, %sw.bb37, %sw.bb36, %sw.bb35, %sw.bb34, %sw.bb33, %sw.bb32, %sw.bb31, %sw.bb30, %sw.bb29, %sw.bb28, %sw.bb27, %sw.bb26, %sw.bb25, %sw.bb24, %sw.bb23, %sw.bb22, %sw.bb21, %sw.bb20, %sw.bb19, %sw.bb18, %sw.bb17, %sw.bb16, %sw.bb15, %sw.bb14, %sw.bb13, %sw.bb12, %sw.bb11, %sw.bb10, %sw.bb9, %sw.bb8, %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %sw.bb2, %sw.bb, %if.then
