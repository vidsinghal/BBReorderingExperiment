; ModuleID = 'samples/699.bc'
source_filename = "crypto/evp/e_camellia.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.evp_cipher_st = type { i32, i32, i32, i32, i64, i32, ptr, ptr, ptr, i32, ptr, ptr, ptr, ptr, i32, ptr, ptr, ptr, i32, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr }
...
entry:
  ...
  store i32 %enc, ptr %enc.addr, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %ret) #3
  call void @llvm.lifetime.start.p0(i64 4, ptr %mode) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %dat) #3
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call = call ptr @EVP_CIPHER_CTX_get_cipher_data(ptr noundef %0)
  store ptr %call, ptr %dat, align 8, !tbaa !4
  ...
  %3 = load ptr, ptr %dat, align 8, !tbaa !4
...
if.end:                                           ; preds = %entry
  ...
  store i32 %call4, ptr %mode, align 4, !tbaa !8
  %6 = load i32, ptr %mode, align 4, !tbaa !8
  %cmp5 = icmp eq i32 %6, 1
  br i1 %cmp5, label %land.lhs.true, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end
  %7 = load i32, ptr %mode, align 4, !tbaa !8
  %cmp6 = icmp eq i32 %7, 2
  br i1 %cmp6, label %land.lhs.true, label %if.else

land.lhs.true:                                    ; preds = %lor.lhs.false, %if.end
  %8 = load i32, ptr %enc.addr, align 4, !tbaa !8
  %tobool = icmp ne i32 %8, 0
  br i1 %tobool, label %if.else, label %if.then7

if.then7:                                         ; preds = %land.lhs.true
  %9 = load ptr, ptr %dat, align 8, !tbaa !4
  %block = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %9, i32 0, i32 1
  store ptr @Camellia_decrypt, ptr %block, align 8, !tbaa !10
  %10 = load i32, ptr %mode, align 4, !tbaa !8
  %cmp8 = icmp eq i32 %10, 2
  %11 = zext i1 %cmp8 to i64
  %cond = select i1 %cmp8, ptr @Camellia_cbc_encrypt, ptr null
  %12 = load ptr, ptr %dat, align 8, !tbaa !4
  %stream = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %12, i32 0, i32 2
  store ptr %cond, ptr %stream, align 8, !tbaa !13
  br label %if.end13

if.else:                                          ; preds = %land.lhs.true, %lor.lhs.false
  %13 = load ptr, ptr %dat, align 8, !tbaa !4
  %block9 = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %13, i32 0, i32 1
  store ptr @Camellia_encrypt, ptr %block9, align 8, !tbaa !10
  %14 = load i32, ptr %mode, align 4, !tbaa !8
  %cmp10 = icmp eq i32 %14, 2
  %15 = zext i1 %cmp10 to i64
  %cond11 = select i1 %cmp10, ptr @Camellia_cbc_encrypt, ptr null
  %16 = load ptr, ptr %dat, align 8, !tbaa !4
  %stream12 = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %16, i32 0, i32 2
  store ptr %cond11, ptr %stream12, align 8, !tbaa !13
  br label %if.end13
...
cleanup:                                          ; preds = %if.end13, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %dat) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %mode) #3
...
entry:
  ...
  store i64 %len, ptr %len.addr, align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr %dat) #3
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call = call ptr @EVP_CIPHER_CTX_get_cipher_data(ptr noundef %0)
  store ptr %call, ptr %dat, align 8, !tbaa !4
  %1 = load ptr, ptr %dat, align 8, !tbaa !4
...
if.then:                                          ; preds = %entry
  ...
  %7 = load i64, ptr %len.addr, align 8, !tbaa !14
  %8 = load ptr, ptr %dat, align 8, !tbaa !4
...
if.then5:                                         ; preds = %if.else
  ...
  %14 = load i64, ptr %len.addr, align 8, !tbaa !14
  %15 = load ptr, ptr %dat, align 8, !tbaa !4
  ...
  %17 = load ptr, ptr %dat, align 8, !tbaa !4
  %block = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %17, i32 0, i32 1
  %18 = load ptr, ptr %block, align 8, !tbaa !10
...
if.else9:                                         ; preds = %if.else
  %19 = load ptr, ptr %in.addr, align 8, !tbaa !4
  %20 = load ptr, ptr %out.addr, align 8, !tbaa !4
  %21 = load i64, ptr %len.addr, align 8, !tbaa !14
  %22 = load ptr, ptr %dat, align 8, !tbaa !4
  ...
  %24 = load ptr, ptr %dat, align 8, !tbaa !4
  %block13 = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %24, i32 0, i32 1
  %25 = load ptr, ptr %block13, align 8, !tbaa !10
...
entry:
  ...
  store ptr %in, ptr %in.addr, align 8, !tbaa !4
  store i64 %len, ptr %len.addr, align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 8, ptr %bl) #3
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call = call i32 @EVP_CIPHER_CTX_get_block_size(ptr noundef %0)
  %conv = sext i32 %call to i64
  store i64 %conv, ptr %bl, align 8, !tbaa !14
  ...
  store ptr %call1, ptr %dat, align 8, !tbaa !4
  %2 = load i64, ptr %len.addr, align 8, !tbaa !14
  %3 = load i64, ptr %bl, align 8, !tbaa !14
...
if.end:                                           ; preds = %entry
  ...
  %4 = load i64, ptr %bl, align 8, !tbaa !14
  %5 = load i64, ptr %len.addr, align 8, !tbaa !14
  %sub = sub i64 %5, %4
  store i64 %sub, ptr %len.addr, align 8, !tbaa !14
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %9 = load ptr, ptr %block, align 8, !tbaa !10
  ...
  %14 = load ptr, ptr %dat, align 8, !tbaa !4
...
for.inc:                                          ; preds = %for.body
  %15 = load i64, ptr %bl, align 8, !tbaa !14
...
cleanup:                                          ; preds = %for.end, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %bl) #3
  %17 = load i32, ptr %retval, align 4
  ret i32 %17
}
...
entry:
  ...
  store i32 %call1, ptr %num, align 4, !tbaa !8
  %2 = load ptr, ptr %in.addr, align 8, !tbaa !4
  %3 = load ptr, ptr %out.addr, align 8, !tbaa !4
  %4 = load i64, ptr %len.addr, align 8, !tbaa !14
  %5 = load ptr, ptr %dat, align 8, !tbaa !4
...
entry:
  ...
  %10 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %11 = load i32, ptr %num, align 4, !tbaa !8
...
if.then:                                          ; preds = %entry
  ...
  %9 = load ptr, ptr %dat, align 8, !tbaa !4
  %block = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %9, i32 0, i32 1
  %10 = load ptr, ptr %block, align 8, !tbaa !10
  ...
  %11 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %12 = load i32, ptr %num, align 4, !tbaa !8
...
while.body:                                       ; preds = %while.cond
  ...
  %20 = load ptr, ptr %dat, align 8, !tbaa !4
  %block11 = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %20, i32 0, i32 1
  %21 = load ptr, ptr %block11, align 8, !tbaa !10
  ...
  %23 = load i32, ptr %num5, align 4, !tbaa !8
  %call12 = call i32 @EVP_CIPHER_CTX_set_num(ptr noundef %22, i32 noundef %23)
  %24 = load i64, ptr %len.addr, align 8, !tbaa !14
  ...
  %26 = load ptr, ptr %in.addr, align 8, !tbaa !4
  %add.ptr13 = getelementptr inbounds i8, ptr %26, i64 1152921504606846976
  store ptr %add.ptr13, ptr %in.addr, align 8, !tbaa !4
  call void @llvm.lifetime.end.p0(i64 4, ptr %num5) #3
  br label %while.cond, !llvm.loop !18

while.end:                                        ; preds = %while.cond
  %27 = load i64, ptr %len.addr, align 8, !tbaa !14
  %tobool14 = icmp ne i64 %27, 0
  br i1 %tobool14, label %if.then15, label %if.end24

if.then15:                                        ; preds = %while.end
  call void @llvm.lifetime.start.p0(i64 4, ptr %num16) #3
  %28 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call17 = call i32 @EVP_CIPHER_CTX_get_num(ptr noundef %28)
  store i32 %call17, ptr %num16, align 4, !tbaa !8
  %29 = load ptr, ptr %in.addr, align 8, !tbaa !4
  %30 = load ptr, ptr %out.addr, align 8, !tbaa !4
  %31 = load i64, ptr %len.addr, align 8, !tbaa !14
  %mul = mul i64 %31, 8
  %32 = load ptr, ptr %dat, align 8, !tbaa !4
  ...
  %35 = load ptr, ptr %dat, align 8, !tbaa !4
  %block22 = getelementptr inbounds %struct.EVP_CAMELLIA_KEY, ptr %35, i32 0, i32 1
  %36 = load ptr, ptr %block22, align 8, !tbaa !10
  ...
  %38 = load i32, ptr %num16, align 4, !tbaa !8
  %call23 = call i32 @EVP_CIPHER_CTX_set_num(ptr noundef %37, i32 noundef %38)
  call void @llvm.lifetime.end.p0(i64 4, ptr %num16) #3
  br label %if.end24
...
entry:
  ...
  store ptr %in, ptr %in.addr, align 8, !tbaa !4
  store i64 %len, ptr %len.addr, align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 4, ptr %snum) #3
  %0 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call = call i32 @EVP_CIPHER_CTX_get_num(ptr noundef %0)
  store i32 %call, ptr %snum, align 4, !tbaa !8
  call void @llvm.lifetime.start.p0(i64 4, ptr %num) #3
  call void @llvm.lifetime.start.p0(i64 8, ptr %dat) #3
  %1 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %call1 = call ptr @EVP_CIPHER_CTX_get_cipher_data(ptr noundef %1)
  store ptr %call1, ptr %dat, align 8, !tbaa !4
  %2 = load i32, ptr %snum, align 4, !tbaa !8
...
if.end:                                           ; preds = %entry
  %3 = load i32, ptr %snum, align 4, !tbaa !8
  store i32 %3, ptr %num, align 4, !tbaa !8
  %4 = load ptr, ptr %dat, align 8, !tbaa !4
...
if.then2:                                         ; preds = %if.end
  %6 = load ptr, ptr %in.addr, align 8, !tbaa !4
  %7 = load ptr, ptr %out.addr, align 8, !tbaa !4
  %8 = load i64, ptr %len.addr, align 8, !tbaa !14
  %9 = load ptr, ptr %dat, align 8, !tbaa !4
  ...
  %13 = load ptr, ptr %stream4, align 8, !tbaa !13
...
if.else:                                          ; preds = %if.end
  ...
  %16 = load i64, ptr %len.addr, align 8, !tbaa !14
  %17 = load ptr, ptr %dat, align 8, !tbaa !4
  ...
  %21 = load ptr, ptr %block, align 8, !tbaa !10
...
if.end9:                                          ; preds = %if.else, %if.then2
  %22 = load ptr, ptr %ctx.addr, align 8, !tbaa !4
  %23 = load i32, ptr %num, align 4, !tbaa !8
...
cleanup:                                          ; preds = %if.end9, %if.then
  call void @llvm.lifetime.end.p0(i64 8, ptr %dat) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %num) #3
  call void @llvm.lifetime.end.p0(i64 4, ptr %snum) #3
...
!9 = !{!"int", !6, i64 0}
!10 = !{!11, !5, i64 280}
!11 = !{!"", !12, i64 0, !5, i64 280, !6, i64 288}
!12 = !{!"camellia_key_st", !6, i64 0, !9, i64 272}
!13 = !{!6, !6, i64 0}
!14 = !{!15, !15, i64 0}
!15 = !{!"long", !6, i64 0}
!16 = distinct !{!16, !17}
