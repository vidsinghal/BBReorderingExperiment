; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES//852/reordered.bc'
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nofree norecurse noreturn nounwind
define void @xnn_qs8_igemm_minmax_fp32_ukernel_4x4c2s4__sse2_ld128(i64 %a_offset) local_unnamed_addr #0 {
entry:
  %cmp146.not.peel = icmp eq i64 %a_offset, 0
  br label %do.body25
...
do.body25:                                        ; preds = %do.body25.loopexit, %entry
  ...
  %call75.peel = load volatile <2 x i64>, ptr %a.addr.0, align 16
  br i1 %cmp146.not.peel, label %do.body25.loopexit, label %do.body25.loopexit.loopexit
}
