...
define void @xnn_qs8_igemm_minmax_fp32_ukernel_4x4c2s4__avx_ld128(i64 %a_offset) {
entry:
  br label %do.body25
...
do.body74:                                        ; preds = %do.body74, %do.body25
  ...
  %cmp140.not = icmp eq i64 %k.0, 0
  br i1 %cmp140.not, label %do.body25, label %do.body74
}
