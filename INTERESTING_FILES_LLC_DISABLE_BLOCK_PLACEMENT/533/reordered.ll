; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//533/reordered.bc'
...
for.body.us.preheader:                            ; preds = %entry
  ...
  %call11.us = tail call i32 @mknod(ptr %0)
  store i32 0, ptr %target, align 4
  store volatile i32 0, ptr null, align 4294967296
  %1 = load ptr, ptr %target, align 8
  %call11.us.1 = tail call i32 @mknod(ptr %1)
  store i32 0, ptr %target, align 4
  store volatile i32 0, ptr null, align 4294967296
  %2 = load ptr, ptr %target, align 8
  %call11.us.2 = tail call i32 @mknod(ptr %2)
  store i32 0, ptr %target, align 4
  store volatile i32 0, ptr null, align 4294967296
  %3 = load ptr, ptr %target, align 8
  %call11.us.3 = tail call i32 @mknod(ptr %3)
  store i32 0, ptr %target, align 4
  store volatile i32 0, ptr null, align 4294967296
  %4 = load ptr, ptr %target, align 8
  %call11.us.4 = tail call i32 @mknod(ptr %4)
  store i32 0, ptr %target, align 4
  store volatile i32 0, ptr null, align 4294967296
  br label %for.end
...
for.body.preheader:                               ; preds = %entry
  ...
  %call11 = tail call i32 @mknod(ptr %5)
  store i32 0, ptr %target, align 4
  %6 = load ptr, ptr %target, align 8
  %call11.1 = tail call i32 @mknod(ptr %6)
  store i32 0, ptr %target, align 4
  %7 = load ptr, ptr %target, align 8
  %call11.2 = tail call i32 @mknod(ptr %7)
  store i32 0, ptr %target, align 4
  %8 = load ptr, ptr %target, align 8
  %call11.3 = tail call i32 @mknod(ptr %8)
  store i32 0, ptr %target, align 4
  %9 = load ptr, ptr %target, align 8
  %call11.4 = tail call i32 @mknod(ptr %9)
  store i32 0, ptr %target, align 4
  br label %for.end
