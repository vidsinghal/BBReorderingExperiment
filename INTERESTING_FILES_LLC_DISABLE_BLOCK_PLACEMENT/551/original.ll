; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//551/original.bc'
...
if.then33:                                        ; preds = %if.end23.thread, %if.end23
  %2 = phi ptr [ %0, %if.end23.thread ], [ %1, %if.end23 ]
  %call39 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) null, i32 0, ptr null)
  br label %if.end40

if.end40:                                         ; preds = %if.then33, %if.end23
  %3 = phi ptr [ %2, %if.then33 ], [ %1, %if.end23 ]
  %4 = load i32, ptr %3, align 8
  %call78 = tail call i32 (ptr, ...) @printf(ptr nonnull dereferenceable(1) null, i32 %4, i32 0)
  br label %for.cond80
