; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//216/original.bc'
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.body.us
  %i5.02.us = phi ptr [ %add.ptr77.us, %for.body.us ], [ %0, %for.body.us.preheader ]
  %b.01.us = phi ptr [ %add.ptr99.us, %for.body.us ], [ null, %for.body.us.preheader ]
  %1 = load i8, ptr %i5.02.us, align 1
