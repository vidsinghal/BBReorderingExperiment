; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//215/original.bc'
...
if.end.i:                                         ; preds = %entry
  ...
  %0 = ptrtoint ptr %add.ptr17.i to i64
  %1 = trunc i64 %0 to i8
  br label %dhm_read_bignum.exit

dhm_read_bignum.exit:                             ; preds = %entry, %if.end.i
  %2 = phi i8 [ %.pre, %entry ], [ %1, %if.end.i ]
  %conv1.i2 = zext i8 %2 to i64
