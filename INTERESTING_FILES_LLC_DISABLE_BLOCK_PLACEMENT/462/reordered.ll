; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//462/reordered.bc'
...
while.cond.us2:                                   ; preds = %do.body2.us1, %while.cond.us2
  br i1 %cmp5.us, label %while.cond.us2, label %while.end.us5, !llvm.loop !0

while.cond:                                       ; preds = %do.body2, %while.cond
  br i1 %cmp5.us, label %while.cond, label %while.end, !llvm.loop !2
...
while.cond.us:                                    ; preds = %while.cond.us.preheader, %while.cond.us
  br i1 %brmerge, label %while.cond.us, label %infloop, !llvm.loop !3
}
