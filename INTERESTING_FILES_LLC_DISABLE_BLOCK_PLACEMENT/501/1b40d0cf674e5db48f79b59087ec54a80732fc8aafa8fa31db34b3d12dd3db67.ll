...
define void @endElement(i1 %tobool.not, i1 %tobool153.not, i1 %cmp161, i1 %cmp173, i1 %tobool209.not) {
entry:
...
if.else232:                                       ; preds = %if.else200
  %call234 = load volatile ptr, ptr null, align 8
  %call248 = call ptr @gt_str_get()
  unreachable
}

declare ptr @gt_str_get()
