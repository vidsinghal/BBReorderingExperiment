; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//328/reordered.bc'
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.body.us
  ...
  %call1217.us = tail call ptr %2(ptr null, i32 0, i32 0, i32 %1, i32 0, i32 %ci.0)
...
for.body.us.preheader:                            ; preds = %entry
  ...
  %call1217.us.peel = tail call ptr %3(ptr null, i32 0, i32 0, i32 %1, i32 0, i32 %ci.0)
