; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//50/reordered.bc'
...
define noundef i32 @psa_get_empty_key_slot(ptr nocapture readonly %0, i1 %tobool.not) local_unnamed_addr #0 {
entry:
