; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//404/original.bc'
...
middle.block:                                     ; preds = %vector.body
  %2 = extractelement <16 x i8> %wide.load3, i64 15
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %3 = icmp eq i64 %index.next14, %n.vec5
  br i1 %3, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !3

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %4 = extractelement <8 x i8> %wide.load13, i64 7
...
do.body54:                                        ; preds = %do.body54.preheader, %do.body54
  ...
  %5 = load i8, ptr %a0.1, align 1
  tail call void @llvm.lifetime.start.p0(i64 0, ptr null)
  %sub95 = add i64 %k.0, -1
  %cmp96.not = icmp eq i64 %sub95, 0
  br i1 %cmp96.not, label %do.end, label %do.body54, !llvm.loop !4

do.end:                                           ; preds = %do.body54, %vec.epilog.middle.block, %middle.block
  %.lcssa = phi i8 [ %2, %middle.block ], [ %4, %vec.epilog.middle.block ], [ %5, %do.body54 ]
