; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//456/reordered.bc'
...
entry.tail.split:                                 ; preds = %entry.tail
  %6 = load i8, ptr %argv, align 1
  %cmp30 = icmp eq i8 %6, 1
  br i1 %cmp30, label %for.cond, label %if.else33

entry.tail:                                       ; preds = %entry, %sub_1, %sub_2
  %cmp4 = phi i1 [ true, %entry ], [ true, %sub_1 ], [ %5, %sub_2 ]
