; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//250/reordered.bc'
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %0 = icmp ult i64 %1, 448
  br i1 %0, label %for.cond5, label %for.body
