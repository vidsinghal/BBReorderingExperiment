; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//367/original.bc'
...
for.body.prol:                                    ; preds = %for.body.lr.ph, %for.body.prol
  %3 = phi float [ %4, %for.body.prol ], [ %x.promoted, %for.body.lr.ph ]
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.lr.ph
  %.unr = phi float [ %x.promoted, %for.body.lr.ph ], [ %4, %for.body.prol ]
  %n.addr.02.unr = phi i64 [ %n, %for.body.lr.ph ], [ %sub49.prol, %for.body.prol ]
  %.lcssa.unr = phi float [ undef, %for.body.lr.ph ], [ %4, %for.body.prol ]
  %5 = icmp ult i64 %0, 56
  br i1 %5, label %for.cond.for.end_crit_edge, label %for.body

for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  %6 = phi float [ %7, %for.body ], [ %.unr, %for.body.prol.loopexit ]
...
for.cond.for.end_crit_edge:                       ; preds = %for.body, %for.body.prol.loopexit
  %.lcssa = phi float [ %.lcssa.unr, %for.body.prol.loopexit ], [ %7, %for.body ]
