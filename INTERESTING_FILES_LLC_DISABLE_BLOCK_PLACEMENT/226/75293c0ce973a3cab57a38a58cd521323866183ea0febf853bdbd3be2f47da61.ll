...
define void @bli_caxpyf_zen_int_4(ptr %alpha, ptr %a, ptr %x, ptr %y, i1 %cmp, ptr %chi0.sroa.2.0..sroa_idx) {
entry:
...
if.end4:                                          ; preds = %entry
  ...
  %0 = call float @llvm.fmuladd.f32(float %chi0.sroa.0.0.copyload, float %a0c361.sroa.0.0.copyload, float %mul374)
