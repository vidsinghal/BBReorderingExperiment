; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//548/original.bc'
...
for.body:                                         ; preds = %entry
  ...
  %2 = load i64, ptr %input, align 1
  %vecinit1.i1 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %2, i64 0
  %call107 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i1)
  %3 = load i64, ptr %input, align 1
  %vecinit1.i2 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %3, i64 0
  %call111 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i2)
  %4 = load i64, ptr %input, align 1
  %vecinit1.i3 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %4, i64 0
  %call115 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i3)
  %5 = load i64, ptr %0, align 1
  %vecinit1.i4 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %5, i64 0
  %call125 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i4)
  %6 = load i64, ptr %input, align 1
  %vecinit1.i5 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %6, i64 0
  %call129 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i5)
  %7 = load i64, ptr %input, align 1
  %vecinit1.i6 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %7, i64 0
...
for.end:                                          ; preds = %entry
  ...
  %vecinit1.i7 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %8, i64 0
  %call242 = tail call <2 x i64> @_mm_cvtepi8_epi16(<2 x i64> %vecinit1.i7)
  %9 = load i64, ptr %input, align 1
  %vecinit1.i8 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %9, i64 0
