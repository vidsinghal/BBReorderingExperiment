; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//294/reordered.bc'
...
for.body.us.preheader:                            ; preds = %entry
  ...
  %5 = tail call float @llvm.fmuladd.f32(float %4, float %.pre, float 0.000000e+00)
