; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//568/original.bc'
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr i32, ptr %piv, i64 %offset.idx
  %4 = getelementptr i8, ptr %3, i64 16
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, ptr %3, align 4
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, ptr %4, align 4
...
for.cond22.preheader:                             ; preds = %for.body, %middle.block, %entry
  %i__.1.ph = phi i32 [ %1, %middle.block ], [ 1, %entry ], [ %1, %for.body ]
  br label %for.cond22
