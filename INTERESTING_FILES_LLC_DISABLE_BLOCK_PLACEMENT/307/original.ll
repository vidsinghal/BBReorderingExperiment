; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//307/original.bc'
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = getelementptr double, ptr %add.ptr21, i64 %index
  %5 = getelementptr i8, ptr %4, i64 16
  %wide.load = load <2 x double>, ptr %4, align 8
  %wide.load3 = load <2 x double>, ptr %5, align 8
  %6 = getelementptr double, ptr %add.ptr, i64 %index
  %7 = getelementptr i8, ptr %6, i64 16
  store <2 x double> %wide.load, ptr %6, align 8
  store <2 x double> %wide.load3, ptr %7, align 8
...
for.body.prol:                                    ; preds = %for.body.preheader4, %for.body.prol
  ...
  %9 = load double, ptr %arrayidx23.prol, align 8
  %arrayidx24.prol = getelementptr double, ptr %add.ptr, i64 %i.02.prol
  store double %9, ptr %arrayidx24.prol, align 8
