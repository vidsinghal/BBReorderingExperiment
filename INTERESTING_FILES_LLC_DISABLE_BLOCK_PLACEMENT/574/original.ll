; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//574/original.bc'
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr float, ptr %sx, i64 %index
