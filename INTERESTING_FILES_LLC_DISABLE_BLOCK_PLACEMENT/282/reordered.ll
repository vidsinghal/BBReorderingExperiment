; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//282/reordered.bc'
...
vector.memcheck:                                  ; preds = %for.end.preheader
  ...
  %1 = shl nuw nsw i64 %wide.trip.count, 4
  %2 = getelementptr i8, ptr %a, i64 %1
  %scevgep4 = getelementptr i8, ptr %2, i64 -8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %5, label %for.end.preheader5, label %vector.body, !llvm.loop !5
...
for.end:                                          ; preds = %for.end.preheader5, %for.end
  ...
  %6 = load double, ptr %arrayidx18, align 8
...
if.end280:                                        ; preds = %for.end, %entry
  %value.02.lcssa = phi double [ 0.000000e+00, %entry ], [ %6, %for.end ]
