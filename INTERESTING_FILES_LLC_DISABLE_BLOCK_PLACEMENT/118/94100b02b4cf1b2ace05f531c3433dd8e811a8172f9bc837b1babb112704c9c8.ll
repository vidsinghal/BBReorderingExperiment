...
declare ptr @je_mallocx(i32)

define ptr @sicm_arena_alloc_aligned(i64 %align, i1 %cmp.not, i1 %cmp1) {
entry:
...
cond.false:                                       ; preds = %if.then
  ...
  %cttz = call i32 @llvm.cttz.i32(i32 %conv2, i1 false)
  br label %cond.end
...
if.end:                                           ; preds = %cond.end, %entry
  ...
  %call6 = call ptr @je_mallocx(i32 %flags.0)
  ret ptr null
}
