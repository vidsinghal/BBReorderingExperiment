; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//91/original.bc'
...
vector.memcheck:                                  ; preds = %for.body.preheader
  ...
  %scevgep4 = getelementptr i8, ptr %1, i64 %2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store i32 %3, ptr %P, align 4, !alias.scope !0, !noalias !3
