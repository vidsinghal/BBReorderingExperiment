; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//340/reordered.bc'
...
for.body23:                                       ; preds = %for.body23.preheader, %for.body23
  ...
  %1 = getelementptr double, ptr %work, i64 %indvars.iv
