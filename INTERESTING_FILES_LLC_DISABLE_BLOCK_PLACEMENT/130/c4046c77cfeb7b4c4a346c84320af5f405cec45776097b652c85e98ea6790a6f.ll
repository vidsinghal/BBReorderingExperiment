...
define void @bl1_cinvert2s(ptr %alpha, ptr %beta, float %0) {
entry:
...
declare i32 @bl1_is_conj()

define void @bl1_zinvert2s(ptr %alpha, ptr %beta, double %0) {
entry:
