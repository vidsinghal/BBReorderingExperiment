; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//61/original.bc'
...
if.end.i:                                         ; preds = %entry
  %1 = load i32, ptr inttoptr (i64 48 to ptr), align 16
...
if.end12.i:                                       ; preds = %if.then9.i, %if.end.i
  %2 = phi i32 [ 1, %if.then9.i ], [ 0, %if.end.i ]
  %3 = load i32, ptr inttoptr (i64 52 to ptr), align 4
  %cmp14.i = icmp sge i32 %2, %3
