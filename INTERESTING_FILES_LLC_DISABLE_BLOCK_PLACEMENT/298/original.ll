; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//298/original.bc'
...
while.body.peel:                                  ; preds = %entry, %while.cond.outer.loopexit
  ...
  %0 = load i8, ptr %data.addr.0.ph12, align 1
  %cmp38.not.peel = icmp eq i8 %0, 0
