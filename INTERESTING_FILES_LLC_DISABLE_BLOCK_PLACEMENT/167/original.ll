; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//167/original.bc'
...
while.end:                                        ; preds = %while.body, %while.body.prol.loopexit
  ...
  %4 = load i32, ptr %add.ptr2.lcssa, align 4
