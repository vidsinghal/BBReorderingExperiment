...
.L.ZPOSTACCUM1:
	...
	vsubpd	%ymm12, %ymm0, %ymm12
	vsubpd	%ymm13, %ymm0, %ymm13
	jmp	.L.ALPHA_REAL_ONE1
.L.ALPHA_NOT_MINUS11:
	cmpb	$2, %al
	jne	.L.ALPHA_REAL_ONE1
	movq	0, %rax
	vbroadcastsd	(%rax), %ymm0
	vbroadcastsd	8(%rax), %ymm1
	vpermilpd	$5, %ymm4, %ymm3        # ymm3 = ymm4[1,0,3,2]
...
.L.ZROWSTORED1:
	leaq	(,%rsi,2), %rsi
	cmpb	$2, %al
	je	.L.ROW_BETA_NOT_REAL_ONE1
	cmpb	$255, %al
	je	.L.ROW_BETA_REAL_MINUS11
	vmovupd	(%rcx), %ymm0
	vaddpd	%ymm4, %ymm0, %ymm0
	vmovupd	%ymm0, (%rcx)
	vmovupd	(%rcx,%rsi), %ymm0
