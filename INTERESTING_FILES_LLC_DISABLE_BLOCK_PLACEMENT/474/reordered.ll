; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//474/reordered.bc'
...
for.end39.loopexit:                               ; preds = %for.body27, %for.body27.prol.loopexit
  ...
  %2 = fcmp olt double %add35.lcssa, 0.000000e+00
...
for.body27.prol.loopexit:                         ; preds = %for.body27.prol, %entry
  ...
  %3 = icmp ugt i32 %0, -8
  br i1 %3, label %for.end39.loopexit, label %for.body27
