; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//40/reordered.bc'
...
cond.end48:                                       ; preds = %cond.true37, %entry
  %cond49 = phi ptr [ %2, %cond.true37 ], [ null, %entry ]
  %call = tail call ptr @FLA_malloc()
  %1 = load float, ptr %cond49, align 4
  store float %1, ptr %minus_upsilon11, align 4
