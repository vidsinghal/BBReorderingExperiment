; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//13/original.bc'
...
for.body.us.preheader:                            ; preds = %entry
  %0 = load ptr, ptr %test_suite_tests, align 16
  %call2.us.peel = tail call i32 %0()
