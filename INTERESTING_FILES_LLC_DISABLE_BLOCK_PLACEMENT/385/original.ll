; ModuleID = '/local/scratch/a/singhav/BBReorderingExperiment/INTERESTING_FILES_LLC_DISABLE_BLOCK_PLACEMENT//385/original.bc'
...
if.then25:                                        ; preds = %for.cond
  ...
  %arrayidx23 = getelementptr i8, ptr %6, i64 8
  %7 = load i32, ptr %arrayidx23, align 8
